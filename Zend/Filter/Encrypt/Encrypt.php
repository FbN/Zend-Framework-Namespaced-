 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Encrypt implements Filter\FilterInterface
{
    /**
     * Encryption adapter
     */
    ...
    public function setAdapter($options = null)
    {
        ...
        if (Loader\Loader::isReadable('Zend/Filter/Encrypt/' . ucfirst($adapter). '.php')) {
        ...
        if (!$this->\\adapter instanceof EncryptInterface) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception("Encoding adapter '" . $adapter . "' does not implement Zend_Filter_Encrypt_Interface");
        }
