 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Rar extends CompressAbstract
{
    /**
     * Compression Options
     * array(
    ...
    public function __construct($options = null)
    {
        if (!extension_loaded('rar')) {
            ...
            throw new Filter\Exception('This filter needs the rar extension');
        }
    ...
    public function setCallback($callback)
    {
        if (!is_callable($callback)) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('Callback can not be accessed');
        }
    ...
    public function compress($content)
    {
        ...
        if ($callback === null) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('No compression callback available');
        }
        ...
        if ($result !== true) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('Error compressing the RAR Archive');
        }
    ...
    public function decompress($content)
    {
        ...
        if (file_exists($content)) {
            ...
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('RAR Archive not found');
        }
        ...
        if (!$archive) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception("Error opening the RAR Archive");
        }
        ...
        if (!$filelist) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception("Error reading the RAR Archive");
        }
