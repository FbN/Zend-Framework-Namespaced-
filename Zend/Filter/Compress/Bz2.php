 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Bz2 extends CompressAbstract
{
    /**
     * Compression Options
     * array(
    ...
    public function __construct($options = null)
    {
        if (!extension_loaded('bz2')) {
            ...
            throw new Filter\Exception('This filter needs the bz2 extension');
        }
    ...
    public function setBlocksize($blocksize)
    {
        if (($blocksize < 0) || ($blocksize > 9)) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('Blocksize must be between 0 and 9');
        }
    ...
    public function decompress($content)
    {
        ...
        if (file_exists($archive)) {
            ...
            if (!$file) {
                require_once 'Zend/Filter/Exception.php';
                throw new Filter\Exception("Error opening the archive '" . $content . "'");
            }
        ...
        if (is_int($compressed)) {
            require_once 'Zend/Filter/Exception.php';
            throw new Filter\Exception('Error during decompression');
        }
