 ...
 */
class Query
    extends \Zend\Cloud\DocumentService\Query
{
    /**
     ...
     * @return void
     */
    public function __construct(SimpleDb $adapter, $collectionName = null)
    {
    ...
    public function assemble($collectionName = null)
    {
        ...
        if (empty($from)) {
            if (null === $collectionName) {
                ...
                throw new \Zend\Cloud\DocumentService\Exception("Query requires a FROM clause");
            }
