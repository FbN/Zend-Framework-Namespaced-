    ...
    implements QueryAdapter
{
    ...
    public function select($select)
    {
        ...
        if (!is_string($select) && !is_array($select)) {
            ...
            throw new Exception("SELECT argument must be a string or an array of strings");
        }
    ...
    public function from($name)
    {
        if(!is_string($name)) {
            require_once 'Zend/Cloud/DocumentService/Exception.php';           
            throw new Exception("FROM argument must be a string");
        }
    ...
    public function where($cond, $value = null, $op = 'and')
    {
        if (!is_string($cond)) {
            require_once 'Zend/Cloud/DocumentService/Exception.php';           
            throw new Exception("WHERE argument must be a string");
        }
    ...
    public function whereId($value)
    {
        if (!is_scalar($value)) {
            require_once 'Zend/Cloud/DocumentService/Exception.php';           
            throw new Exception("WHEREID argument must be a scalar");
        }
    ...
    public function limit($limit)
    {
        if ($limit != (int) $limit) {
            require_once 'Zend/Cloud/DocumentService/Exception.php';           
            throw new Exception("LIMIT argument must be an integer");
        }
