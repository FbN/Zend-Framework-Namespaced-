...
class FileSystem implements Adapter
{
    ...
    public function __construct($options = array()) 
    {
        ...
        if (!is_array($options)) {
            throw new Cloud\StorageService\Exception('Invalid options provided');
        }
    ...
    public function storeMetadata($destinationPath, $metadata, $options = array()) 
    {
        ...
        throw new Cloud\OperationNotAvailableException('Storing metadata not implemented');
    }
    ...
    {
        require_once 'Zend/Cloud/OperationNotAvailableException.php';
        throw new Cloud\OperationNotAvailableException('Deleting metadata not implemented');
    }
