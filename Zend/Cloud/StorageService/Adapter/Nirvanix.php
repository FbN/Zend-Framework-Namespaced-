    ...
    implements Adapter
{
    ...
    function __construct($options = array()) 
    {
        ...
        if (isset($options[self::HTTP_ADAPTER])) {
            $httpc = new \Zend\Http\Client\Client();
            $httpc->setAdapter($options[self::HTTP_ADAPTER]);
            $nirvanix_options['httpClient'] = $httpc;
        } 
        try {
            $this->_nirvanix = new Nirvanix\Nirvanix($auth, $nirvanix_options);
...
//                // TODO Differentiate among errors in the Nirvanix adapter
    ...
    public function renameItem($path, $name, $options = null) 
    {
        ...
        throw new \Zend\Cloud\OperationNotAvailableException('Renaming not implemented');
    }
    ...
    public function fetchMetadata($path, $options = null)
    {
        ...
        try {
            ...
            throw new StorageService\Exception('Error on fetching metadata: '.$e->getMessage(), $e->getCode(), $e);
        }
    ...
    public function storeMetadata($destinationPath, $metadata, $options = null)
    {
        ...
        if ($metadata != null) {
            try {
                ...
                throw new StorageService\Exception('Error on storing metadata: '.$e->getMessage(), $e->getCode(), $e);
            }
        }
     }
    ...
    public function deleteMetadata($path, $metadata = null, $options = null)
    {
        ...
        try {
            ...
            throw new StorageService\Exception('Error on deleting metadata: '.$e->getMessage(), $e->getCode(), $e);
        }            
    }
