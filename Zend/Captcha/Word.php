 ...
 */
abstract class Word extends Base
{
    /**#@+
    ...
    public function getSession()
    {
        if (!isset($this->_session) || (null === $this->_session)) {
            ...
            if (!class_exists($this->_sessionClass)) {
                ...
                \Zend\Loader\Loader::loadClass($this->_sessionClass);
            }
            $this->_session = new $this->\\sessionClass('Zend_Form_Captcha_' . $id);
     ...
     * @return Zend_Captcha_Word
     */
    public function setSession(\Zend\Session\Namespace $session)
    {
