 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Method extends Member\AbstractMember
{
    /**
    ...
    public static function fromReflection(\Zend\Reflection\Method $reflectionMethod)
    {
        ...
        if ($reflectionMethod->getDocComment() != '') {
            $method->setDocblock(Docblock\Docblock::fromReflection($reflectionMethod->getDocblock()));
        }
        ...
        foreach ($reflectionMethod->getParameters() as $reflectionParameter) {
            $method->setParameter(Parameter\Parameter::fromReflection($reflectionParameter));
        }
    ...
    public function setParameter($parameter)
    {
        if (is_array($parameter)) {
            $parameter = new Parameter\Parameter($parameter);
            $parameterName = $parameter->getName();
        } elseif ($parameter instanceof Parameter\Parameter) {
            $parameterName = $parameter->getName();
        } else {
