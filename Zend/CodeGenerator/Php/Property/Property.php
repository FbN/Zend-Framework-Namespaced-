 ...
 * @namespace
 */
namespace Zend\CodeGenerator\Php\Property;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Property extends \Zend\CodeGenerator\Php\Member\AbstractMember
{
    ...
    public static function fromReflection(\Zend\Reflection\Property $reflectionProperty)
    {
        ...
        if ($reflectionProperty->getDocComment() != '') {
            $property->setDocblock(\Zend\CodeGenerator\Php\Docblock\Docblock::fromReflection($reflectionProperty->getDocComment()));
        }
    ...
    public function setDefaultValue($defaultValue)
    {
        ...
        if (is_array($defaultValue)
            ...
            $defaultValue = new DefaultValue($defaultValue);
        }

        if (!($defaultValue instanceof DefaultValue)) {
            $defaultValue = new DefaultValue(array('value' => $defaultValue));
        }
    ...
    public function generate()
    {
        ...
        if ($this->isConst()) {
            if ($defaultValue != null && !$defaultValue->isValidConstantType()) {
                ...
                throw new \Zend\CodeGenerator\Php\Exception('The property ' . $this->_name . ' is said to be '
