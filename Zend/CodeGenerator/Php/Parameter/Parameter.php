 ...
 * @namespace
 */
namespace Zend\CodeGenerator\Php\Parameter;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Parameter extends \Zend\CodeGenerator\Php\AbstractPhp
{
    /**
     * @var string
     */
     ...
     */
    public static function fromReflection(\Zend\Reflection\Parameter $reflectionParameter)
    {
        $param = new Parameter();
    ...
    public function setDefaultValue($defaultValue)
    {
        if($defaultValue === null) {
            $this->_defaultValue = new DefaultValue("null");
        } else if(is_array($defaultValue)) {
            $defaultValue = str_replace(array("\r", "\n"), "", var_export($defaultValue, true));
            $this->_defaultValue = new DefaultValue($defaultValue);
        } else if(is_bool($defaultValue)) {
            if($defaultValue == true) {
                $this->_defaultValue = new DefaultValue("true");
            } else {
                $this->_defaultValue = new DefaultValue("false");
            }
        } else {
    ...
    public function generate()
    {
        ...
        if ($this->_defaultValue !== null) {
            ...
            } else if($this->_defaultValue instanceof DefaultValue) {
