 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Tag extends \Zend\CodeGenerator\Php\AbstractPhp
{
     ...
     */
    public static function fromReflection(\Zend\Reflection\Docblock\Tag\Tag $reflectionTag)
    {
     ...
     */
    public static function setPluginLoader(PluginLoader\PluginLoader $pluginLoader)
    {
    ...
    public static function getPluginLoader()
    {
        if (self::$_pluginLoader == null) {
            ...
            self::setPluginLoader(new PluginLoader\PluginLoader(array(
    ...
    public static function factory($tagName)
    {
        ...
        } catch (\Zend\Loader\Exception $exception) {
