 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class File extends AbstractPhp
{
    ...
    public static function registerFileCodeGenerator(File $fileCodeGenerator, $fileName = null)
    {
        if ($fileName == null) {
    ...
    public static function fromReflectedFileName($filePath, $usePreviousCodeGeneratorIfItExists = true, $includeIfNotAlreadyIncluded = true)
    {
        ...
        $codeGenerator = self::fromReflection(($fileReflector = new Reflection\File($realpath)));
    ...
    public static function fromReflection(Reflection\File $reflectionFile)
    {
        ...
        foreach ($reflectionFile->getClasses() as $class) {
            $file->setClass(Class::fromReflection($class));
        ...
        if (($reflectionFile->getDocComment() != '')) {
            ...
            $file->setDocblock(Docblock\Docblock::fromReflection($docblock));
