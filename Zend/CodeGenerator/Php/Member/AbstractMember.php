 ...
 * @namespace
 */
namespace Zend\CodeGenerator\Php\Member;
use Zend\CodeGenerator\Php\Docblock;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class AbstractMember extends \Zend\CodeGenerator\Php\AbstractPhp
{
    ...
    public function setDocblock($docblock)
    {
        ...
        if (is_array($docblock)) {
            ...
            throw new \Zend\CodeGenerator\Php\Exception('setDocblock() is expecting either a string, array or an instance of Zend_CodeGenerator_Php_Docblock');
        }
