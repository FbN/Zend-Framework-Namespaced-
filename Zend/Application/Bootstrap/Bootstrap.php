    ...
    extends BootstrapAbstract
{
     ...
     */
    public function setResourceLoader(\Zend\Loader\Autoloader\Resource $loader)
    {
    ...
    public function getResourceLoader()
    {
        if ((null === $this->_resourceLoader)
            ...
            $path = $r->getFileName();
            $this->setResourceLoader(new \Zend\Application\Module\Autoloader(array(
                'namespace' => $namespace,
