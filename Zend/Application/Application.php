...
class Application
{
    ...
    public function __construct($environment, $options = null)
    {
        ...
        $this->_autoloader = \Zend\Loader\Autoloader\Autoloader::getInstance();
    ...
    public function setBootstrap($path, $class = null)
    {
        ...
        if (!$this->\\bootstrap instanceof Bootstrap\Bootstrapper) {
            throw new Exception('Bootstrap class does not implement Zend_Application_Bootstrap_Bootstrapper');
        }
    ...
    public function getBootstrap()
    {
        if (null === $this->_bootstrap) {
            $this->_bootstrap = new Bootstrap\Bootstrap($this);
        }
