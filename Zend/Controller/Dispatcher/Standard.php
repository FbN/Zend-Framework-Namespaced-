...
class Standard extends AbstractDispatcher
{
    ...
    public function isDispatchable(Request\AbstractRequest $request)
    {
        ...
        return Loader\Loader::isReadable($test);
    }
     ...
     */
    public function dispatch(Request\AbstractRequest $request, Controller\Response\AbstractResponse $response)
    {
        ...
        if (!($controller instanceof Controller\Action\ActionInterface) &&
            !($controller instanceof Controller\Action\Action)) {
            require_once 'Zend/Controller/Dispatcher/Exception.php';
            throw new Exception(
    ...
    public function loadClass($className)
    {
        ...
        if (Loader\Loader::isReadable($loadFile)) {
    ...
    public function getDefaultControllerClass(Request\AbstractRequest $request)
    {
        ...
        if ($this->isValidModule($module)) {
            ...
            if (class_exists($default, false)) {
                ...
                if (Loader\Loader::isReadable($fileSpec)) {
                    $found = true;
