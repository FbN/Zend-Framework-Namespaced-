    ...
    extends AbstractHelper
{
    ...
    {
        $cache = $this->getCache(Cache\Manager::PAGECACHE);
        if ($recursive) {
            $backend = $cache->getBackend();
            if (($backend instanceof Cache\Backend\Backend)
    ...
    {
        return $this->getCache(Cache\Manager::PAGECACHE)
            ->clean(Cache\Cache::CLEANING_MODE_MATCHING_ANY_TAG, $tags);
    }
    ...
    public function preDispatch()
    {
        ...
        in_array($action, $this->_caching[$controller])) {
            ...
            $this->getCache(Cache\Manager::PAGECACHE)
     ...
     * @return void
     */
    public function setManager(Cache\Manager $manager)
    {
    ...
    public function getManager()
    {
        ...
        $this->_manager = new Cache\Manager;
        return $this->_manager;
    }
