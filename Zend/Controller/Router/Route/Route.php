...
class Route extends AbstractRoute
{
     ...
     * @return void
     */
    public static function setDefaultTranslator(Translate\Translate $translator = null)
    {
     ...
     * @return void
     */
    public function setTranslator(Translate\Translate $translator)
    {
        $this->_translator = $translator;
    }
    ...
    public function getTranslator()
    {
        if ($this->_translator !== null) {
            ...
            if ($translator instanceof Translate\Translate) {
                return $translator;
            }
        }
    ...
    public function getLocale()
    {
        if ($this->_locale !== null) {
            ...
            try {
                $locale = end\Registry::get('Zend_Locale');
            } catch (end\Exception $e) {
                $locale = null;
            }
