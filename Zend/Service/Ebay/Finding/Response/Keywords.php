 ...
 */
class Keywords extends AbstractResponse
{
    /**
     ...
     */
    public function findItems(Finding\Finding $proxy, $options = null)
    {
        // prepare options
        $options = \Zend\Service\Ebay\AbstractEbay::optionsToArray($options);
