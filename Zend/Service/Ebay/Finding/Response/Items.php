 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding\Response;
 ...
 */
class Items extends Histograms
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($node) {
            ...
            $this->searchResult = new Finding\Search\Result($node);
        }
        ...
        if ($node) {
            ...
            $this->paginationOutput = new Finding\PaginationOutput($node);
        }
    }
     ...
     */
    public function page(Finding\Finding $proxy, $number)
    {
        // check page number
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pageFirst(Finding\Finding $proxy)
    {
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pageLast(Finding\Finding $proxy, $max = self::PAGE_MAX_DEFAULT)
    {
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pageNext(Finding\Finding $proxy, $max = self::PAGE_MAX_DEFAULT)
    {
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pagePrevious(Finding\Finding $proxy)
    {
