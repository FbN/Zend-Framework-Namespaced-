 ...
 */
abstract class AbstractResponse extends \Zend\Service\Ebay\Finding\AbstractFinding
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($node) {
            ...
            $this->errorMessage = new \Zend\Service\Ebay\Finding\Error\Message($node);
        }
    }
    ...
    {
        if ($name instanceof \Zend\Config\Config) {
            $name = $name->toArray();
        }
        if (is_array($name)) {
            $this->_options = $name;
