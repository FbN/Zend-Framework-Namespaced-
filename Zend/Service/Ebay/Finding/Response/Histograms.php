 ...
 */
class Histograms extends AbstractResponse
{
    /**
    ...
    {
        parent::_init();
        $ns = \Zend\Service\Ebay\Finding\Finding::XMLNS_FINDING;
        ...
        if ($node) {
            ...
            $this->aspectHistogramContainer = new \Zend\Service\Ebay\Finding\Aspect\Histogram\Container($node);
        }
        ...
        if ($node) {
            ...
            $this->categoryHistogramContainer = new \Zend\Service\Ebay\Finding\Category\Histogram\Container($node);
        }
    }
}
