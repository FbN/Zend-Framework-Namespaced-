 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding\Category\Histogram;
 ...
 */
class Histogram extends \Zend\Service\Ebay\Finding\Category\Category
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($nodes->length > 0) {
            ...
            $this->childCategoryHistogram = new Set($nodes);
        }
    }
}
