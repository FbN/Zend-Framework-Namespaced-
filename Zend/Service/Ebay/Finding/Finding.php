 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding;
 ...
 */
class Finding extends \Zend\Service\Ebay\AbstractEbay
{
    ...
    {
        if (!$this->_client instanceof Client\Client) {
            /**
    ...
    protected function _findItems(array $options, $operation)
    {
        ...
        $response = new Response\Items($dom->firstChild);
    ...
    public function getHistograms($categoryId, $options = null)
    {
        ...
        $response = new Response\Histograms($dom->firstChild);
        return $response->setOperation($operation)
                        ->setOption($options);
    }
    ...
    public function getSearchKeywordsRecommendation($keywords, $options = null)
    {
        ...
        $response = new Response\Keywords($dom->firstChild);
        return $response->setOperation($operation)
                        ->setOption($options);
    }
     ...
     * @return DOMDocument
     */
    protected function _parseResponse(\Zend\Http\Response\Response $response)
    {
        // error message
        $message = '';
