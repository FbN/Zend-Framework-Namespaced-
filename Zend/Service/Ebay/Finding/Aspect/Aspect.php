 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding\Aspect;
 ...
 */
class Aspect extends \Zend\Service\Ebay\Finding\AbstractFinding
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($nodes->length > 0) {
            ...
            $this->valueHistogram = new Histogram\Value\Set($nodes);
        }
    }
}
