 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding\Aspect\Histogram;
 ...
 */
class Container extends \Zend\Service\Ebay\Finding\AbstractFinding
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($nodes->length > 0) {
            ...
            $this->aspect = new \Zend\Service\Ebay\Finding\Aspect\Set($nodes);
        }
    }
}
