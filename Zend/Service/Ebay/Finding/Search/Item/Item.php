 ...
 * @namespace
 */
namespace Zend\Service\Ebay\Finding\Search\Item;
use Zend\Service\Ebay\Finding;
use Zend\Service\Ebay\Finding\Category;
 ...
 */
class Item extends Finding\AbstractFinding
{
    /**
    ...
    {
        parent::_init();
        $ns = Finding\Finding::XMLNS_FINDING;
        ...
        if ($node) {
            ...
            $this->listingInfo = new Finding\ListingInfo($node);
        }
        ...
        if ($node) {
            ...
            $this->primaryCategory = new Category\Category($node);
        }
        ...
        if ($node) {
             ...
             */
            require_once 'Zend/Service/Ebay/Finding/Category.php';
            $this->secondaryCategory = new Category\Category($node);
        }
        ...
        if ($node) {
            ...
            $this->sellerInfo = new Finding\SellerInfo($node);
        }
        ...
        if ($node) {
            ...
            $this->sellingStatus = new Finding\SellingStatus($node);
        }
        ...
        if ($node) {
            ...
            $this->shippingInfo = new Finding\ShippingInfo($node);
        }
        ...
        if ($node) {
            ...
            $this->storeInfo = new Finding\Storefront($node);
        }
    }
     ...
     */
    public function findItemsByProduct(Finding\Finding $proxy, $options = null)
    {
