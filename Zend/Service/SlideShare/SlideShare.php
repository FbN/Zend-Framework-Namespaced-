...
class SlideShare
{
    ...
    public function getHttpClient()
    {
        ...
        if(!($this->_httpclient instanceof Client\Client)) {
     ...
     * @return Zend_Service_SlideShare
     */
    public function setCacheObject(Cache\Core $cacheobject)
    {
    ...
    public function getCacheObject()
    {
        ...
        if(!($this->_cacheobject instanceof Cache\Core)) {
            $cache = Cache\Cache::factory('Core', 'File', array('lifetime' => 43200,
