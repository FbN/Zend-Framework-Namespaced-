...
class Technorati
{
    ...
    public function getRestClient()
    {
        if ($this->_restClient === null) {
            ...
            $this->_restClient = new \Zend\Rest\Client\Client(self::API_URI_BASE);
        }
     ...
     * @access  protected
     */
    protected function _convertResponseAndCheckContent(Response\Response $response)
    {
        $dom = new \DOMDocument();
     ...
     * @access  protected
     */
    protected static function _checkResponse(Response\Response $response)
    {
        if ($response->isError()) {
            /**
             * @see Zend_Service_Technorati_Exception
