...
class Base
{
    ...
    public function __construct($options = array())
    {
        ...
        if (! isset($options['httpClient'])) {
            $options['httpClient'] = new Client\Client();
        }
    ...
    public function __call($methodName, $args)
    {
        ...
        $httpResponse = $this->_httpClient->request(Client\Client::POST);
    ...
    {
        return new \Zend\Service\Nirvanix\Response($httpResponse->getBody());
    }
}
