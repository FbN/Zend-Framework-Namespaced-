 ...
 * @namespace
 */
namespace Zend\Service\Nirvanix\Namespace;
...
class Imfs extends Base
{
    ...
    public function getContents($filePath, $expiration = 3600)
    {
        ...
        $resp = $this->_httpClient->request(Client\Client::GET);
    ...
    public function putContents($filePath, $data, $mimeType = null)
    {
        ...
        $response = $this->_httpClient->request(Client\Client::POST);

        return new \Zend\Service\Nirvanix\Response($response->getBody());
    }
