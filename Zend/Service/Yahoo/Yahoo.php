...
class Yahoo
{
    ...
    public function __construct($appId)
    {
        ...
        $this->_rest = new \Zend\Rest\Client\Client('http://search.yahooapis.com');
    }
    ...
    public function inlinkDataSearch($query, array $options = array())
    {
        ...
        return new InlinkDataResultSet($dom);
    }
    ...
    public function pageDataSearch($query, array $options = array())
    {
        ...
        return new PageDataResultSet($dom);
    }
    ...
    protected function _validateInlinkDataSearch(array $options)
    {
        ...
        $between = new Validate\Between(1, 100, true);
        ...
        if (isset($options['results']) && !$between->setMin(1)->setMax(100)->isValid($options['results'])) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'results': {$options['results']}");
        }
        ...
        if (isset($options['start']) && !$between->setMin(1)->setMax(1000)->isValid($options['start'])) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'start': {$options['start']}");
        }
    ...
    protected function _validateImageSearch(array $options)
    {
        ...
        if (isset($options['type'])) {
            switch($options['type']) {
                ...
                default:
                     ...
                     */
                    require_once 'Zend/Service/Exception.php';
                    throw new Service\Exception("Invalid value for option 'type': '{$options['type']}'");
            }
        }
         ...
         */
        require_once 'Zend/Validate/Between.php';
        $between = new Validate\Between(1, 50, true);
        ...
        if (isset($options['format'])) {
            switch ($options['format']) {
                ...
                default:
                     ...
                     */
                    require_once 'Zend/Service/Exception.php';
                    throw new Service\Exception("Invalid value for option 'format': {$options['format']}");
            }
        }
        ...
        if (isset($options['coloration'])) {
            switch ($options['coloration']) {
                ...
                default:
                     ...
                     */
                    require_once 'Zend/Service/Exception.php';
                    throw new Service\Exception("Invalid value for option 'coloration': "
                                                   . "{$options['coloration']}");
            }
        }
    }
    ...
    protected function _validateLocalSearch(array $options)
    {
         ...
         */
        require_once 'Zend/Validate/Between.php';
        $between = new Validate\Between(1, 20, true);
        ...
        if (isset($options['longitude']) && !$between->setMin(-90)->setMax(90)->isValid($options['longitude'])) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'longitude': {$options['longitude']}");
        }
        ...
        if (isset($options['latitude']) && !$between->setMin(-180)->setMax(180)->isValid($options['latitude'])) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'latitude': {$options['latitude']}");
        }
        ...
        if (isset($options['zip']) && !preg_match('/(^\d{5}$)|(^\d{5}-\d{4}$)/', $options['zip'])) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'zip': {$options['zip']}");
        }
        ...
        if (!$hasLocation && (!isset($options['latitude']) || !isset($options['longitude']))) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception('Location data are required but missing');
        }
        ...
        if (!in_array($options['sort'], array('relevance', 'title', 'distance', 'rating'))) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option 'sort': {$options['sort']}");
        }
    }
    ...
    protected function _validateLanguage($lang)
    {
        ...
        if (!in_array($lang, $languages)) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("The selected language '$lang' is not supported");
        }
    }
    ...
    protected function _compareOptions(array $options, array $validOptions)
    {
        ...
        if ($difference) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception('The following parameters are invalid: ' . join(', ', $difference));
        }
    }
    ...
    protected function _validateInArray($name, $value, array $array)
    {
        if (!in_array($value, $array)) {
             ...
             */
            require_once 'Zend/Service/Exception.php';
            throw new Service\Exception("Invalid value for option '$name': $value");
        }
    }
