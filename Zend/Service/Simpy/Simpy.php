...
class Simpy
{
    ...
    {
        $this->_http = new \Zend\Http\Client\Client;
    ...
    protected function _makeRequest($op, $query = null)
    {
         ...
         */
        require_once 'Zend/Service/Exception.php';
        throw new Service\Exception($response->getMessage(), $response->getStatus());
    }
     ...
     */
    public function getLinks(LinkQuery $q = null)
    {
        if ($q != null) {
            $query = array(
                'q'          => $q->getQueryString(),
    ...
    public function getWatchlist($watchlistId)
    {
        ...
        return new Watchlist($doc->documentElement);
    }
