...
use Zend\Oauth;
use Zend\Oauth\Token;
use Zend\Http\Client;
use Zend\Rest\Client\Result;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Twitter extends \Zend\Rest\Client\Client
{
    ...
    public function __construct($options = null, Oauth\Consumer $consumer = null)
    {
        ...
        && $options['accessToken'] instanceof Token\Access) {
     ...
     * @return self
     */
    public function setLocalHttpClient(Client\Client $client)
    {
    ...
    public function __call($method, $params)
    {
        if (method_exists($this->_oauthConsumer, $method)) {
            ...
            if ($return instanceof Token\Access) {
    ...
    public function statusPublicTimeline()
    {
        ...
        return new Result\Result($response->getBody());
    }
    ...
    public function blockExists($id, $returnResult = false)
    {
        ...
        $cr = new Result\Result($response->getBody());
    ...
    protected function _prepare($path)
    {
        ...
        if (!$this->_uri instanceof \Zend\Uri\Http) {
            require_once 'Zend/Rest/Client/Exception.php';
            throw new \Zend\Rest\Client\Exception(
    ...
    protected function _get($path, array $query = null)
    {
        ...
        return $this->_localHttpClient->request(Client\Client::GET);
    }
    ...
    {
        $this->_prepare($path);
        return $this->_performPost(Client\Client::POST, $data);
    }
