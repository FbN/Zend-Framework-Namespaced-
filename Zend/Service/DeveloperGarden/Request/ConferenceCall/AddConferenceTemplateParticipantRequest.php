 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class AddConferenceTemplateParticipantRequest
    extends \Zend\Service\DeveloperGarden\Request\RequestAbstract
{
    ...
    public function __construct($environment, $templateId,
        ConferenceCall\ParticipantDetail $participant = null
    ) {
     ...
     * @return Zend_Service_DeveloperGarden_Request_ConferenceCall_AddConferenceTemplateParticipantRequest
     */
    public function setParticipant(ConferenceCall\ParticipantDetail $participant)
    {
