 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\Request\ConferenceCall;
use Zend\Service\DeveloperGarden\ConferenceCall;
use Zend\Service\DeveloperGarden\ConferenceCall;
...
class CreateConferenceRequest
    extends \Zend\Service\DeveloperGarden\Request\RequestAbstract
{
    /**
    ...
    public function __construct($environment, $ownerId,
        ConferenceCall\ConferenceDetail $conferenceDetails,
        ConferenceCall\ConferenceSchedule $conferenceSchedule = null,
        $account = null
    ) {
    ...
    public function setSchedule(
        ConferenceCall\ConferenceSchedule $schedule = null
    ) {
     ...
     * @return Zend_Service_DeveloperGarden_Request_ConferenceCall_CreateConferenceRequest
     */
    public function setDetail(ConferenceCall\ConferenceDetail $detail)
    {
        $this->detail = $detail;
        return $this;
    }
