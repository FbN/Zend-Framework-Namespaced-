 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\ConferenceCall;
...
class ConferenceCall
    extends \Zend\Service\DeveloperGarden\Client\ClientAbstract
{
    /**
     * wsdl file
     *
    ...
    public function createConference($ownerId,
        ConferenceDetail $conferenceDetails,
        ConferenceSchedule $conferenceSchedule = null,
        $account = null
    ) {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\CreateConferenceRequest(
            $this->getEnvironment(),
            $ownerId,
            $conferenceDetails,
            $conferenceSchedule,
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\CommitConferenceRequest(
            $this->getEnvironment(),
            $conferenceId
        );
    ...
    public function updateConference(
        $conferenceId,
        $ownerId = null,
        ConferenceDetail $conferenceDetails = null,
        ConferenceSchedule $conferenceSchedule = null,
        $account = null
    ) {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\UpdateConferenceRequest(
            $this->getEnvironment(),
            $conferenceId,
            $ownerId,
            $conferenceDetails,
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetConferenceStatusRequest(
            $this->getEnvironment(),
            $conferenceId,
            $what
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetRunningConferenceRequest(
            $this->getEnvironment(),
            $conferenceId
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\RemoveConferenceRequest(
            $this->getEnvironment(),
            $conferenceId
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetConferenceListRequest(
            $this->getEnvironment(),
            $what,
            $ownerId
        );
    ...
    public function newParticipant(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\NewParticipantRequest(
            $this->getEnvironment(),
            $conferenceId,
            $participant
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetParticipantStatusRequest(
            $this->getEnvironment(),
            $conferenceId,
            $participantId
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\RemoveParticipantRequest(
            $this->getEnvironment(),
            $conferenceId,
            $participantId
        );
    ...
    public function updateParticipant(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\UpdateParticipantRequest(
            $this->getEnvironment(),
            $conferenceId,
            $participantId,
            $action,
    ...
    public function createConferenceTemplate(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\CreateConferenceTemplateRequest(
            $this->getEnvironment(),
            $ownerId,
            $conferenceDetails,
            $participants
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetConferenceTemplateRequest(
            $this->getEnvironment(),
            $templateId
        );
    ...
    public function updateConferenceTemplate(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\UpdateConferenceTemplateRequest(
            $this->getEnvironment(),
            $templateId,
            $initiatorId,
            $conferenceDetails
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\RemoveConferenceTemplateRequest(
            $this->getEnvironment(),
            $templateId
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetConferenceTemplateListRequest(
            $this->getEnvironment(),
            $ownerId
        );
    ...
    public function addConferenceTemplateParticipant(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\AddConferenceTemplateParticipantRequest(
            $this->getEnvironment(),
            $templateId,
            $participant
        );
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\GetConferenceTemplateParticipantRequest(
            $this->getEnvironment(),
            $templateId,
            $participantId
        );
    ...
    public function updateConferenceTemplateParticipant(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\UpdateConferenceTemplateParticipantRequest(
            $this->getEnvironment(),
            $templateId,
            $participantId,
            $participant
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\ConferenceCall\RemoveConferenceTemplateParticipantRequest(
            $this->getEnvironment(),
            $templateId,
            $participantId
        );
