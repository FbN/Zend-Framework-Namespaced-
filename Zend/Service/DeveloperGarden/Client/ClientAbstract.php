 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\Client;
use Zend\Service\DeveloperGarden;
...
abstract class ClientAbstract
{
     ...
     * @var int
     */
    protected $_serviceEnvironment = ClientAbstract::ENV_PRODUCTION;
    ...
    {
        $this->_credential = new DeveloperGarden\Credential();
        ...
        if (empty($this->_wsdlFile)) {
            ...
            throw new DeveloperGarden\Exception('_wsdlFile not set for this service.');
        }
        ...
        if (empty($this->_wsdlFileLocal) || $this->_wsdlFileLocal === false) {
            require_once 'Zend/Service/DeveloperGarden/Exception.php';
            throw new DeveloperGarden\Exception('_wsdlFileLocal not set for this service.');
        }
    }
    ...
    final public function getSoapClient()
    {
        if ($this->_soapClient === null) {
            ...
            $tokenService = new DeveloperGarden\SecurityTokenServer\SecurityTokenServer(
                array(
    ...
    public function getClientOptions()
    {
        ...
        $wsdlCache = DeveloperGarden\SecurityTokenServer\Cache::getWsdlCache();
        if ($wsdlCache !== null) {
