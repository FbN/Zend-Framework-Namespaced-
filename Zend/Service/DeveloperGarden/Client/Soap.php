...
use Zend\Service\DeveloperGarden\Response\SecurityTokenServer;
use Zend\Service\DeveloperGarden\Response\SecurityTokenServer;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Soap extends \Zend\Soap\Client\Client
{
    /**
     ...
     */
    public function setTokenService(\Zend\Service\DeveloperGarden\SecurityTokenServer\SecurityTokenServer $tokenService)
    {
     ...
     * @return Zend_Service_DeveloperGarden_Client_Soap
     */
    public function setCredential(\Zend\Service\DeveloperGarden\Credential $credential)
    {
    ...
    public function getWsseTokenHeader(
        SecurityTokenServer\SecurityTokenResponse $token
    ) {
    ...
    public function getWsseSecurityTokenHeader(
        SecurityTokenServer\GetTokensResponse $token
    ) {
        $format = '<wsse:%s xmlns:wsse="%s" SOAP-ENV:mustUnderstand="1">%s</wsse:%s>';
        $securityHeader = sprintf(
            $format,
