 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\LocalSearch;
    ...
    extends \Zend\Service\DeveloperGarden\Client\ClientAbstract
{
    ...
    public function localSearch(
        ...
        $request = new \Zend\Service\DeveloperGarden\Request\LocalSearch\LocalSearchRequest(
            $this->getEnvironment(),
            $searchParameters,
            $account
        );
        ...
        $response = new \Zend\Service\DeveloperGarden\Response\LocalSearch\LocalSearchResponse($result);
