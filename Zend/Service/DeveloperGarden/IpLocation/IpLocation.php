 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\IpLocation;
    ...
    extends \Zend\Service\DeveloperGarden\Client\ClientAbstract
{
    ...
    {
        $request = new \Zend\Service\DeveloperGarden\Request\IpLocation\LocateIPRequest(
            $this->getEnvironment(),
            $ip
        );
        ...
        $response = new \Zend\Service\DeveloperGarden\Response\IpLocation\LocateIPResponse($result);
