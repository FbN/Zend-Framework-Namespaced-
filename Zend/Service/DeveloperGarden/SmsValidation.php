 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SmsValidation extends Client\ClientAbstract
{
// @codeCoverageIgnoreStart
    ...
    {
        $request = new Request\SmsValidation\Validate(
            $this->getEnvironment(),
            $keyword,
            $number
        );
    ...
    {
        $request = new Request\SmsValidation\Invalidate(
            $this->getEnvironment(),
            $number
        );
    ...
    {
        $request = new Request\SmsValidation\SendValidationKeyword(
            $this->getEnvironment()
        );
    ...
    {
        $request = new Request\SmsValidation\GetValidatedNumbers(
            $this->getEnvironment()
        );
        return $this->getSoapClient()
