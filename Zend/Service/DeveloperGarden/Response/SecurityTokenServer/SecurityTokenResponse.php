 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\Response\SecurityTokenServer;
...
class SecurityTokenResponse
    extends \Zend\Service\DeveloperGarden\Response\ResponseAbstract
    implements SecurityTokenServerInterface
{
    /**
    ...
    public function getTokenData()
    {
        if (empty($this->tokenData)) {
            ...
            throw new \Zend\Service\DeveloperGarden\Response\Exception('No valid tokenData found.');
        }
