 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\Response\IpLocation;
    ...
    extends \Zend\Service\DeveloperGarden\Response\BaseType
{
    ...
    public function __construct(
        LocateIPResponseType $response
    ) {
        if ($response->ipAddressLocation instanceof IPAddressLocationType) {
    ...
    public function parse()
    {
        ...
        } elseif ($this->ipAddressLocation instanceof IPAddressLocationType) {
