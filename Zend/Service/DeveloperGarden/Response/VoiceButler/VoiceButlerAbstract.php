 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden\Response\VoiceButler;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class VoiceButlerAbstract
    extends \Zend\Service\DeveloperGarden\Response\ResponseAbstract
{
    ...
    {
        if ($this->hasError()) {
            throw new \Zend\Service\DeveloperGarden\Response\Exception(
