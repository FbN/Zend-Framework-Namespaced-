 ...
 * @namespace
 */
namespace Zend\Service\DeveloperGarden;
...
class Credential
{
    ...
    public function setPassword($password = null)
    {
        if (empty($password)) {
            ...
            throw new Client\Exception('Empty password not permitted.');
        }

        if (!is_string($password)) {
            require_once 'Zend/Service/DeveloperGarden/Client/Exception.php';
            throw new Client\Exception('Password must be a string.');
        }
    ...
    public function setUsername($username = null)
    {
        if (empty($username)) {
            require_once 'Zend/Service/DeveloperGarden/Client/Exception.php';
            throw new Client\Exception('Empty username not permitted.');
        }

        if (!is_string($username)) {
            require_once 'Zend/Service/DeveloperGarden/Client/Exception.php';
            throw new Client\Exception('Username must be a string.');
        }
    ...
    public function setRealm($realm = null)
    {
        if (empty($realm)) {
            require_once 'Zend/Service/DeveloperGarden/Client/Exception.php';
            throw new Client\Exception('Empty realm not permitted.');
        }

        if (!is_string($realm)) {
            require_once 'Zend/Service/DeveloperGarden/Client/Exception.php';
            throw new Client\Exception('Realm must be a string.');
        }
