 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class BatchStorageAbstract
    extends Storage
{	
    /**
     * Current batch
	 ...
	 */
	public function performBatch($operations = array(), $forTableStorage = false, $isSingleSelect = false, $resourceType = Storage::RESOURCE_UNKNOWN, $requiredPermission = \Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::PERMISSION_READ)
	{
	    // Generate boundaries
