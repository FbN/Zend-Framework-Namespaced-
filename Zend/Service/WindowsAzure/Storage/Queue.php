...
class Queue extends Storage
{
	 ...
	 */
	public function __construct($host = StorageStorage::URL_DEV_QUEUE, $accountName = Credentials\CredentialsAbstractCredentials\CredentialsAbstract::DEVSTORE_ACCOUNT, $accountKey = Credentials\CredentialsAbstractCredentials\CredentialsAbstract::DEVSTORE_KEY, $usePathStyleUri = false, WindowsAzure\RetryPolicy\RetryPolicyAbstract $retryPolicy = null)
	{
