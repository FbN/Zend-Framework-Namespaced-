    ...
    extends BatchStorageAbstract
{
	 ...
	 */
	public function __construct($host = StorageStorage::URL_DEV_TABLE, $accountName = Credentials\CredentialsAbstractCredentials\CredentialsAbstract::DEVSTORE_ACCOUNT, $accountKey = Credentials\CredentialsAbstractCredentials\CredentialsAbstract::DEVSTORE_KEY, $usePathStyleUri = false, WindowsAzure\RetryPolicy\RetryPolicyAbstract $retryPolicy = null)
	{
	...
	public function retrieveEntities($tableName = '', $filter = '', $entityClass = 'Zend_Service_WindowsAzure_Storage_DynamicTableEntity', $nextPartitionKey = null, $nextRowKey = null)
	{
		...
		if (is_string($tableName)) {
    		...
    		// Filter?
    		if ($filter !== '') {
    		    $query[] = '$filter=' . TableEntityQuery::encodeQuery($filter);
    		}
	...
	protected function _changeEntity($httpVerb = Client\ClientClient\Client::PUT, $tableName = '', TableEntity $entity = null, $verifyEtag = false)
	{
        ...
        if ($timestamp == TableEntity::DEFAULT_TIMESTAMP) {
