...
abstract class CredentialsAbstract
{
	...
	public function __construct(
		$accountName = CredentialsAbstractCredentialsAbstract::DEVSTORE_ACCOUNT,
		$accountKey  = CredentialsAbstractCredentialsAbstract::DEVSTORE_KEY,
	 ...
	 */
	public function setAccountName($value = CredentialsAbstractCredentialsAbstract::DEVSTORE_ACCOUNT)
	{
	 ...
	 * @return Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
	 */
	public function setAccountkey($value = CredentialsAbstractCredentialsAbstract::DEVSTORE_KEY)
	{
	...
	abstract public function signRequestUrl(
		...
		$requiredPermission = CredentialsAbstractCredentialsAbstract::PERMISSION_READ
	);
