    ...
    extends CredentialsAbstract
{
	...
	public function signRequestHeaders(
		...
		// Table storage?
		if (!$forTableStorage) {
			throw new Exception('The Windows Azure SDK for PHP does not support SharedKeyLite authentication on blob or queue storage. Use SharedKey authentication instead.');
		}
