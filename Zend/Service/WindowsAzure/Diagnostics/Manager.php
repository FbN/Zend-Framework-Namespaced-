...
class Manager
{
	 ...
	 */
	public function __construct(\Zend\Service\WindowsAzure\Storage\Blob\Blob $blobStorageClient = null, $controlContainer = 'wad-control-container')
	{
	...
	public function configurationForRoleInstanceExists($roleInstance = null)
	{
		if ($roleInstance === null) {
			throw new Exception('Role instance should be specified. Try reading $_SERVER[\'RdRoleId\'] for this information if the application is hosted on Windows Azure Fabric or Development Fabric.');
		}
	 ...
	 * @throws Zend_Service_WindowsAzure_Diagnostics_Exception
	 */
	public function setConfigurationForCurrentRoleInstance(ConfigurationInstance $configuration)
	{
		if (!isset($_SERVER['RdRoleId'])) {
			throw new Exception('Server variable \'RdRoleId\' is unknown. Please verify the application is running in Development Fabric or Windows Azure Fabric.');
		}
	...
	public function getConfigurationForRoleInstance($roleInstance = null)
	{
		...
		if ($this->_blobStorageClient->blobExists($this->_controlContainer, $roleInstance)) {
			$configurationInstance = new ConfigurationInstance();
	 ...
	 * @throws Zend_Service_WindowsAzure_Diagnostics_Exception
	 */
	public function setConfigurationForRoleInstance($roleInstance = null, ConfigurationInstance $configuration)
	{
		if ($roleInstance === null) {
			throw new Exception('Role instance should be specified. Try reading $_SERVER[\'RdRoleId\'] for this information if the application is hosted on Windows Azure Fabric or Development Fabric.');
		}
