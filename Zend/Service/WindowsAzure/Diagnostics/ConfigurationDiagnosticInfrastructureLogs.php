 ...
 */
class ConfigurationDiagnosticInfrastructureLogs
	extends ConfigurationObjectBaseAbstract
{
	 ...
	 */
    public function __construct($bufferQuotaInMB = 0, $scheduledTransferPeriodInMinutes = 0, $scheduledTransferLogLevelFilter = LogLevelLogLevel::UNDEFINED) 
    {	        
        $this->_data = array(
