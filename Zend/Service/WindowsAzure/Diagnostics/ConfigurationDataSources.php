 ...
 */
class ConfigurationDataSources
	extends ConfigurationObjectBaseAbstract
{
    ...
    {	        
        $this->_data = array(
            ...
            'logs'             				=> new ConfigurationLogs(),
            'diagnosticinfrastructurelogs'  => new ConfigurationDiagnosticInfrastructureLogs(),
            'performancecounters'     		=> new ConfigurationPerformanceCounters(),
            'windowseventlog'              	=> new ConfigurationWindowsEventLog(),
            'directories'             		=> new ConfigurationDirectories()
        );
    }
}