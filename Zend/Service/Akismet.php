 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Akismet extends AbstractService
{
    /**
     * Akismet API key
     * @var string
    ...
    public function setBlogUrl($blogUrl)
    {
        ...
        if (!\Zend\Uri\Uri::check($blogUrl)) {
            require_once 'Zend/Service/Exception.php';
            throw new Exception('Invalid url provided for blog');
        }
    ...
    protected function _post($host, $path, array $params)
    {
        ...
        $client->setMethod(\Zend\Http\Client\Client::POST);
