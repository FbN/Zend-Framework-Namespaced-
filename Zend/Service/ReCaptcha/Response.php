...
class Response
{
     ...
     */
    public function __construct($status = null, $errorCode = null, Response\Response $httpResponse = null)
    {
        if ($status !== null) {
     ...
     * @return Zend_Service_ReCaptcha_Response
     */
    public function setFromHttpResponse(Response\Response $response)
    {
