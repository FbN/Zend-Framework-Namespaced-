 ...
 * @namespace
 */
namespace Zend\Service\ReCaptcha\MailHide;
 ...
 */
class MailHide extends \Zend\Service\ReCaptcha\ReCaptcha
{
    /**#@+
    ...
    public function getEmailValidator()
    {
        if (null === $this->_emailValidator) {
            ...
            $this->setEmailValidator(new \Zend\Validate\EmailAddress());
        }
     ...
     */
    public function setEmailValidator(\Zend\Validate\ValidateInterface $validator)
    {
    ...
    protected function _requireMcrypt()
    {
        if (!extension_loaded('mcrypt')) {
            ...
            throw new Exception('Use of the Zend_Service_ReCaptcha_MailHide component requires the mcrypt extension to be enabled in PHP');
        }
    }
