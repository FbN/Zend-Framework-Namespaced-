 ...
 * @namespace
 */
namespace Zend\Service\ShortUrl;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class TinyUrlCom extends AbstractShortener
{
    /**
    ...
    public function unshorten($shortenedUrl)
    {
        ...
        $this->setHttpClient(new \Zend\Http\Client\Client());
        ...
        $dom = new \Zend\Dom\Query\Query($response->getBody());
