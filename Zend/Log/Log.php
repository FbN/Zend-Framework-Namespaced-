...
class Log
{
     ...
     */
    public function __construct(Writer\AbstractWriter $writer = null)
    {
    ...
    static public function factory($config = array())
    {
        ...
        if (!is_array($config) || empty($config)) {
            ...
            throw new Exception('Configuration must be an array or instance of Zend_Config');
        }
    ...
    protected function _constructWriterFromConfig($config)
    {
        ...
        if (!$writer instanceof Writer\AbstractWriter) {
            ...
            /** @see Zend_Log_Exception */
            require_once 'Zend/Log/Exception.php';
            throw new Exception("{$writerName} does not extend Zend_Log_Writer_Abstract!");
        }
    ...
    protected function _constructFilterFromConfig($config)
    {
        ...
        if (!$filter instanceof Filter\FilterInterface) {
            ...
            /** @see Zend_Log_Exception */
            require_once 'Zend/Log/Exception.php';
            throw new Exception("{$filterName} does not implement Zend_Log_Filter_Interface");
        }
    ...
    protected function _constructFromConfig($type, $config, $namespace)
    {
        ...
        if (!class_exists($className)) {
            ...
            \Zend\Loader\Loader::loadClass($className);
        }
    ...
    public function addFilter($filter)
    {
        ...
        } elseif ($filter instanceof Config\Config || is_array($filter)) {
    ...
    {
        if (is_array($writer) || $writer instanceof  Config\Config) {
