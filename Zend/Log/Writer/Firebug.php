...
class Firebug extends AbstractWriter
{
     ...
     * @var array
     */
    protected $_priorityStyles = array(Log\Log::EMERG  => FirePhp\FirePhp::ERROR,
                                       Log\Log::ALERT  => FirePhp\FirePhp::ERROR,
                                       Log\Log::CRIT   => FirePhp\FirePhp::ERROR,
                                       Log\Log::ERR    => FirePhp\FirePhp::ERROR,
                                       Log\Log::WARN   => FirePhp\FirePhp::WARN,
                                       Log\Log::NOTICE => FirePhp\FirePhp::INFO,
                                       Log\Log::INFO   => FirePhp\FirePhp::INFO,
                                       Log\Log::DEBUG  => FirePhp\FirePhp::LOG);
