 ...
 */
class DbTable
    extends \Zend\Db\Table\AbstractTable
    implements SaveHandlerInterface
{
    ...
    {
        \Zend\Session\Session::writeClose();
    }
     ...
     * @return int
     */
    protected function _getLifetime(Row\AbstractRow $row)
    {
        $return = $this->_lifetime;
     ...
     * @return int
     */
    protected function _getExpirationTime(Row\AbstractRow $row)
    {
