...
class Session extends AbstractSession
{
    ...
    public static function start($options = false)
    {
        ...
        if (self::$_strict && $options === true) {
            /** @see Zend_Session_Exception */
            require_once 'Zend/Session/Exception.php';
            throw new Exception('You must explicitly start the session with Zend_Session::start() when session options are set to strict.');
        }
     ...
     * @return void
     */
    public static function registerValidator(Validator\ValidatorInterface $validator)
    {
        $validator->setup();
    }
    ...
    private static function _processValidators()
    {
        foreach ($_SESSION['__ZF']['VALID'] as $validator_name => $valid_data) {
            if (!class_exists($validator_name)) {
                ...
                \Zend\Loader\Loader::loadClass($validator_name);
            }
    ...
    public static function namespaceUnset($namespace)
    {
        ...
        Namespace::resetSingleInstance($namespace);
    }
