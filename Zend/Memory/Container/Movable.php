 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Movable extends Container {
    /**
     * Internal object Id
     *
     * @var integer
     ...
     * @param string $value
     */
    public function __construct(Memory\Manager $memoryManager, $id, $value)
    {
    ...
    public function __get($property)
    {
        if ($property != 'value') {
            ...
            throw new Memory\Exception('Unknown property: Zend_Memory_container::$' . $property);
        }
