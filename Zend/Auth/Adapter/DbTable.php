...
class DbTable implements AdapterInterface
{
     ...
     * @return void
     */
    public function __construct(Adapter\AbstractAdapter $zendDb = null, $tableName = null, $identityColumn = null,
     ...
     */
    protected function _setDbAdapter(Adapter\AbstractAdapter $zendDb = null)
    {
        $this->_zendDb = $zendDb;
        ...
        if(null === $this->_zendDb) {
            ...
            $this->_zendDb = \Zend\Db\Table\AbstractTable::getDefaultAdapter();
            if (null === $this->_zendDb) {
    ...
    public function authenticate()
    {
        ...
        if ( ($authResult = $this->_authenticateValidateResultSet($resultIdentities)) instanceof Auth\Result) {
            return $authResult;
        }
    ...
    protected function _authenticateCreateSelect()
    {
        ...
        $credentialExpression = new \Zend\Db\Expr(
            '(CASE WHEN ' .
     ...
     * @return array
     */
    protected function _authenticateQuerySelect(\Zend\Db\Select\Select $dbSelect)
    {
        try {
            if ($this->_zendDb->getFetchMode() != \Zend\DB::FETCH_ASSOC) {
                $origDbFetchMode = $this->_zendDb->getFetchMode();
                $this->_zendDb->setFetchMode(\Zend\DB::FETCH_ASSOC);
            }
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Exception('The supplied parameters to Zend_Auth_Adapter_DbTable failed to '
    ...
    protected function _authenticateValidateResultSet(array $resultIdentities)
    {
        ...
        if (count($resultIdentities) < 1) {
            $this->_authenticateResultInfo['code'] = Auth\Result::FAILURE_IDENTITY_NOT_FOUND;
            $this->_authenticateResultInfo['messages'][] = 'A record with the supplied identity could not be found.';
            return $this->_authenticateCreateAuthResult();
        } elseif (count($resultIdentities) > 1 && false === $this->getAmbiguityIdentity()) {
            $this->_authenticateResultInfo['code'] = Auth\Result::FAILURE_IDENTITY_AMBIGUOUS;
    ...
    protected function _authenticateValidateResult($resultIdentity)
    {
        ...
        if ($resultIdentity[$zendAuthCredentialMatchColumn] != '1') {
            $this->_authenticateResultInfo['code'] = Auth\Result::FAILURE_CREDENTIAL_INVALID;
        ...
        $this->_authenticateResultInfo['code'] = Auth\Result::SUCCESS;
