 ...
 * @namespace
 */
namespace Zend\Auth\Adapter\Http;
use Zend\Auth\Adapter;
use Zend\Auth;
 ...
 */
class Http implements Auth\Adapter\AdapterInterface
{
    /**
    ...
    public function __construct(array $config)
    {
        if (!extension_loaded('hash')) {
            ...
            throw new Adapter\Exception(__CLASS__  . ' requires the \'hash\' extension');
        }
        ...
        if (empty($config['accept_schemes'])) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('Config key \'accept_schemes\' is required');
        }
        ...
        if (empty($this->_acceptSchemes)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('No supported schemes given in \'accept_schemes\'. Valid values: '
        ...
        if (empty($config['realm']) ||
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('Config key \'realm\' is required, and must contain only printable '
        ...
        if (in_array('digest', $this->_acceptSchemes)) {
            if (empty($config['digest_domains']) ||
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new Adapter\Exception('Config key \'digest_domains\' is required, and must contain '
            ...
            if (empty($config['nonce_timeout']) ||
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new Adapter\Exception('Config key \'nonce_timeout\' is required, and must be an '
                                                    . 'integer');
            } else {
     ...
     */
    public function setBasicResolver(Resolver\ResolverInterface $resolver)
    {
     ...
     * @return Zend_Auth_Adapter_Http Provides a fluent interface
     */
    public function setDigestResolver(Resolver\ResolverInterface $resolver)
    {
     ...
     * @return Zend_Auth_Adapter_Http Provides a fluent interface
     */
    public function setRequest(\Zend\Controller\Request\Http $request)
    {
     ...
     * @return Zend_Auth_Adapter_Http Provides a fluent interface
     */
    public function setResponse(\Zend\Controller\Response\Http $response)
    {
    ...
    public function authenticate()
    {
        if (empty($this->_request) ||
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('Request and Response objects must be set before calling '
                                                . 'authenticate()');
        }
        ...
        if (!in_array($clientScheme, $this->_supportedSchemes)) {
            ...
            return new Auth\Result(
                Auth\Result::FAILURE_UNCATEGORIZED,
                array(),
        ...
        switch ($clientScheme) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new Adapter\Exception('Unsupported authentication scheme');
        }
    ...
    protected function _challengeClient()
    {
        ...
        return new Auth\Result(
            Auth\Result::FAILURE_CREDENTIAL_INVALID,
            array(),
    ...
    protected function _basicAuth($header)
    {
        if (empty($header)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('The value of the client Authorization header is required');
        }
        if (empty($this->_basicResolver)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('A basicResolver object must be set before doing Basic '
                                                . 'authentication');
        }
        ...
        if (!$auth) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Adapter\Exception('Unable to base64_decode Authorization header value');
        }
    ...
    protected function _digestAuth($header)
    {
        ...
        switch ($data['qop']) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new Adapter\Exception('Client requested an unsupported qop option');
        }
