 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Truncate implements \PHPUnit\Extensions\Database\Operation\IDatabaseOperation
{
    /**
     *
    ...
    public function execute(\PHPUnit\Extensions\Database\DB\IDatabaseConnection $connection, \PHPUnit\Extensions\Database\DataSet\IDataSet $dataSet)
    {
        ...
        foreach ($dataSet->getReverseIterator() AS $table) {
            try {
                ...
                throw new \PHPUnit\Extensions\Database\Operation\Exception('TRUNCATE', 'TRUNCATE '.$tableName.'', array(), $table, $e->getMessage());
            }
        }
    }
