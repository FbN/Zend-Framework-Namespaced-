 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SimpleTester extends \PHPUnit\Extensions\Database\DefaultTester
{
    /**
     ...
     */
    public function __construct(\PHPUnit\Extensions\Database\DB\IDatabaseConnection $connection)
    {
        ...
        $this->setUpOperation = new \PHPUnit\Extensions\Database\Operation\Composite(array(
            new Operation\Truncate(),
            new Operation\Insert(),
        ));
        $this->tearDownOperation = \PHPUnit\Extensions\Database\Operation\Factory::NONE();
    }
     ...
     */
    public function setUpDatabase(\PHPUnit\Extensions\Database\DataSet\IDataSet $dataSet)
    {
