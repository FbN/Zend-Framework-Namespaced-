 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class DbTable extends \PHPUnit\Extensions\Database\DataSet\QueryTable
{
    /**
    ...
    protected function createTableMetaData()
    {
        if ($this->tableMetaData === NULL) {
            $this->loadData();
            $this->tableMetaData = new \PHPUnit\Extensions\Database\DataSet\DefaultTableMetaData($this->tableName, $this->_columns);
        }
    }
}