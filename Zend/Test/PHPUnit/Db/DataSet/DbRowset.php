 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class DbRowset extends \PHPUnit\Extensions\Database\DataSet\AbstractTable
{
    /**
    ...
    public function __construct(\Zend\Db\Table\Rowset\AbstractRowset $rowset, $tableName = null)
    {
        ...
        $this->tableMetaData = new \PHPUnit\Extensions\Database\DataSet\DefaultTableMetaData($this->tableName, $columns);
    }
}