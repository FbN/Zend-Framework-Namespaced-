...
class Cloud
{
    ...
    public function setTags(array $tags)
    {
        ...
        foreach ($tags as $tag) {
            if ($tag instanceof Tag\Taggable) {
                $itemList[] = $tag;
            } else if (is_array($tag)) {
                $itemList[] = new Tag\Item($tag);
            } else {
                require_once 'Zend/Tag/Cloud/Exception.php';
                throw new Exception('Tag must be an instance of Zend_Tag_Taggable or an array');
            }
        }
     ...
     * @return Zend_Tag_Cloud
     */
    public function setItemList(Tag\ItemList $itemList)
    {
        $this->_tags = $itemList;
        return $this;
    }
    ...
    public function getItemList()
    {
        if (null === $this->_tags) {
            ...
            $this->setItemList(new Tag\ItemList());
        }
        return $this->_tags;
    }
    ...
    public function setCloudDecorator($decorator)
    {
        ...
        if (!($decorator \instanceof Decorator\Cloud)) {
            require_once 'Zend/Tag/Cloud/Exception.php';
            throw new Exception('Decorator is no instance of Zend_Tag_Cloud_Decorator_Cloud');
        }
    ...
    public function setTagDecorator($decorator)
    {
        ...
        if (!($decorator \instanceof Decorator\Tag)) {
            require_once 'Zend/Tag/Cloud/Exception.php';
            throw new Exception('Decorator is no instance of Zend_Tag_Cloud_Decorator_Tag');
        }
