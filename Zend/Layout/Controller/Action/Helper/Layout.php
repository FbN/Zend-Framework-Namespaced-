...
class Layout extends \Zend\Controller\Action\Helper\AbstractHelper
{
     ...
     * @return void
     */
    public function __construct(Layout\Layout $layout = null)
    {
        if (null !== $layout) {
    ...
    public function getLayoutInstance()
    {
        if (null === $this->_layout) {
             ...
             */
            require_once 'Zend/Layout.php';
            if (null === ($this->_layout = Layout\Layout::getMvcInstance())) {
     ...
     */
    public function setLayoutInstance(Layout\Layout $layout)
    {
        $this->_layout = $layout;
        return $this;
    }
