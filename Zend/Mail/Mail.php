...
class Mail extends Mime\Message
{
     ...
     * @return Zend_Mail Provides fluent interface
    */
    public function setBodyText($txt, $charset = null, $encoding = Mime\MimeMime\Mime::ENCODING_QUOTEDPRINTABLE)
    {
        if ($charset === null) {
     ...
     * @return Zend_Mail Provides fluent interface
     */
    public function setBodyHtml($html, $charset = null, $encoding = Mime\MimeMime\Mime::ENCODING_QUOTEDPRINTABLE)
    {
        if ($charset === null) {
            $charset = $this->_charset;
        }
    ...
    public function createAttachment($body,
                                     $mimeType    = Mime\MimeMime\Mime::TYPE_OCTETSTREAM,
                                     $disposition = Mime\MimeMime\Mime::DISPOSITION_ATTACHMENT,
                                     $encoding    = Mime\MimeMime\Mime::ENCODING_BASE64,
                                     $filename    = null)
    {
