...
class Smtp extends AbstractTransport
{
    ...
    {
        if ($this->_connection instanceof Smtp\Smtp) {
            try {
     ...
     * @return void
     */
    public function setConnection(\Zend\Mail\Protocol\AbstractProtocol $connection)
    {
    ...
    public function _sendMail()
    {
        ...
        if (!($this->_connection instanceof Smtp\Smtp)) {
            ...
            if (!class_exists($connectionClass)) {
                ...
                \Zend\Loader\Loader::loadClass($connectionClass);
            }
            $this->setConnection(new $connectionClass($this->\\host, $this->_port, $this->_config));
        ...
        $this->_connection->data($this->header . \Zend\Mime\Mime::LINEEND . $this->body);
    }
