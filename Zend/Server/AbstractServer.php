...
abstract class AbstractServer implements ServerInterface
{
     ...
     */
    protected function _buildCallback(Reflection\Function\AbstractFunction $reflection)
    {
        ...
        } elseif ($reflection instanceof Reflection\Function\Function) {
     ...
     */
    protected function _buildSignature(Reflection\Function\AbstractFunction $reflection, $class = null)
    {
    ...
    protected function _dispatch(Method\Definition $invocable, array $params)
    {
        ...
        return \call\user\func\array(array($object, $method), $params);
    }
