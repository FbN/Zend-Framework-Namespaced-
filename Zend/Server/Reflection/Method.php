 ...
 */
class Method extends Function\AbstractFunction
{
    /**
     * Parent class name
     * @var string
     ...
     * @return void
     */
    public function __construct(Class $class, \ReflectionMethod $r, $namespace = null, $argv = array())
    {
    ...
    {
        $this->_classReflection = new Class(new \ReflectionClass($this->_class), $this->getNamespace(), $this->getInvokeArguments());
