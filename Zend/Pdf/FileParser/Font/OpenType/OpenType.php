 ...
 * @namespace
 */
namespace Zend\Pdf\FileParser\Font\OpenType;
use Zend\Pdf;
use Zend\Pdf;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class OpenType extends Pdf\FileParser\Font\Font
{
  /**** Instance Variables ****/
  ...
  /* Parser Methods */
    ...
    protected function _parseCmapTable()
    {
        ...
        $this->cmap = Pdf\Cmap\Cmap::cmapWithTypeData($cmapType, $cmapData);
    }
