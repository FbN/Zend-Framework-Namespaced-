 ...
 * @namespace
 */
namespace Zend\Pdf\FileParser\Font;
use Zend\Pdf\FileParser;
use Zend\Log;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Font extends FileParser\FileParser
{
  /**** Instance Variables ****/
  ...
  /* Object Lifecycle */
     ...
     */
    public function __construct(FileParserDataSource\FileParserDataSource $dataSource)
    {
  ...
  /* Parser Methods */
    ...
    public function readStringUTF16($byteCount,
                                    $byteOrder = FileParser\FileParserFileParser\FileParser::BYTE_ORDER_BIG_ENDIAN,
                                    $characterSet = '')
    {
  ...
  /* Internal Utility Methods */
    ...
    protected function _debugLog($message)
    {
        ...
        $logger = new Log\Log();
        $logger->log($message, Log\Log::DEBUG);
    }
}
