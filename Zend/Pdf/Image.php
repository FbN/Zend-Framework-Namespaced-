...
abstract class Image
{
  ...
  /* Factory Methods */
    ...
    public static function imageWithPath($filePath)
    {
        ...
        return Resource\ImageFactory::factory($filePath);
        ...
        $dataSource = new FileParserDataSource\File($filePath);
    ...
    protected static function _extractJpegImage($dataSource)
    {
        ...
        $imageParser = new \Zend\Pdf\FileParser\Image\Jpeg($dataSource);
    ...
    protected static function _extractPngImage($dataSource)
    {
        ...
        $imageParser = new FileParser\Image\Png($dataSource);
    ...
    protected static function _extractTiffImage($dataSource)
    {
        ...
        $imageParser = new \Zend\Pdf\FileParser\Image\Tiff($dataSource);
