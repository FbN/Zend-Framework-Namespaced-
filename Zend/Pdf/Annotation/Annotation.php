...
abstract class Annotation
{
    ...
    public function setText($text) {
        ...
        if ($this->_annotationDictionary->Contents === null) {
            ...
            $this->_annotationDictionary->Contents = new String\String($text);
        } else {
            $this->_annotationDictionary->Contents->touch();
            $this->_annotationDictionary->Contents->value = new String\String($text);
        }
    ...
    public function __construct(Element\Element $annotationDictionary)
    {
        ...
        if (count($this->_annotationDictionary->Rect->items) != 4 ||
            $this->_annotationDictionary->Rect->items[0]->getType() != Element\Element::TYPE_NUMERIC ||
            $this->_annotationDictionary->Rect->items[1]->getType() != Element\Element::TYPE_NUMERIC ||
            $this->_annotationDictionary->Rect->items[2]->getType() != Element\Element::TYPE_NUMERIC ||
            $this->_annotationDictionary->Rect->items[3]->getType() != Element\Element::TYPE_NUMERIC ) {
            require_once 'Zend/Pdf/Exception.php';
