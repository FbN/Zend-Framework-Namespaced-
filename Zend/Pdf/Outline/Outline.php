 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Outline implements \RecursiveIterator, \Countable
{
    /**
    ...
    public static function create($param1, $param2 = null)
    {
        ...
        if (is_string($param1)) {
            if ($param2 !== null  &&  !($param2 instanceof Pdf\Target  ||  is_string($param2))) {
                require_once 'Zend/Pdf/Exception.php';
     ...
     */
    abstract public function dumpOutline(ElementFactory\ElementFactoryInterface $factory,
                                                                           $updateNavigation,
