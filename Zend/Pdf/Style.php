...
class Style
{
    ...
    public function setLineWidth($width)
    {
        ...
        $this->_lineWidth = new Element\Numeric($width);
    }
    ...
    public function setLineDashingPattern($pattern, $phase = 0)
    {
        ...
        $this->_lineDashingPhase   = new Element\Numeric($phase);
    }
     ...
     */
    public function setFont(Resource\Font\Font $font, $fontSize)
    {
        $this->_font = $font;
