...
class ElementFactory implements ElementFactoryInterface
{
    ...
    static public function createFactory($objCount)
    {
        ...
        return new Proxy(new ElementFactory($objCount));
    }
     ...
     * @throws Zend_Pdf_Exception
     */
    public function markAsModified(Object\Object $obj)
    {
     ...
     * @throws Zend_Pdf_Exception
     */
    public function remove(Object\Object $obj)
    {
     ...
     */
    public function newObject(Pdf\Element\Element $objectValue)
    {
        require_once 'Zend/Pdf/Element/Object.php';
        $obj = new Object\Object($objectValue, $this->_objectCount++, 0, $this);
        $this->_modifiedObjects[$obj->getObjNum()] = $obj;
        return $obj;
    }
    ...
    public function newStreamObject($streamValue)
    {
        ...
        $obj = new Pdf\Element\Object\Stream($streamValue, $this->_objectCount++, 0, $this);
        $this->_modifiedObjects[$obj->getObjNum()] = $obj;
        return $obj;
    }
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        foreach ($this->_modifiedObjects as $objNum => $obj) {
            if ($this->_removedObjects->contains($obj)) {
                            $result[$objNum+$shift] = new Pdf\UpdateInfoContainer($objNum + $shift,
                                                                           $obj->getGenNum()+1,
                                                                           true);
            } else {
                $result[$objNum+$shift] = new Pdf\UpdateInfoContainer($objNum + $shift,
     ...
     * @param Zend_Pdf_Element_Object $obj
     */
    public function registerObject(Object\Object $obj, $refString)
    {
