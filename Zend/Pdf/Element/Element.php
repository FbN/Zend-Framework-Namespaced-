...
abstract class Element
{
     ...
     */
    public function setParentObject(Object\Object $parent)
    {
    ...
    public static function phpToPdf($input)
    {
        if (is_numeric($input)) {
            ...
            foreach ($input as $key => $value) {
                ...
                $pdfElementsArray[$key] = Element::phpToPdf($value);
            }

            if ($isDictionary) {
                require_once 'Zend/Pdf/Element/Dictionary.php';
                return new Dictionary($pdfElementsArray);
            } else {
                require_once 'Zend/Pdf/Element/Array.php';
                return new Array($pdfElementsArray);
            }
        } else {
            require_once 'Zend/Pdf/Element/String.php';
            return new String\String((string)$input);
        }
    }
}
