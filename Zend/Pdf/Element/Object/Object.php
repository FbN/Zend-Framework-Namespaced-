 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Object extends Element\Element
{
    /**
     * Object value
     *
     ...
     */
    public function __construct(Element\Element $val, $objNum, $genNum, ElementFactory\ElementFactory $factory)
    {
        if ($val instanceof self) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Pdf\Exception('Object number must not be an instance of Zend_Pdf_Element_Object.');
        }
    ...
    public function makeClone(ElementFactory\ElementFactory $factory, array &$processed, $mode)
    {
        ...
        $processed[$id] = $clonedObject = $factory->newObject(new Element\Null());

        // Pecursively process actual data
        $clonedObject->_value = $this->_value->makeClone($factory, $processed, $mode);

        if ($clonedObject->_value instanceof Element\Null) {
