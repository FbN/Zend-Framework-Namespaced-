 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Reference extends Pdf\Element\Element
{
    /**
     * Object value
     ...
     */
    public function __construct($objNum, $genNum = 0, Context $context, ElementFactory\ElementFactory $factory)
    {
    ...
    private function _dereference()
    {
        ...
        if ($obj === null ) {
            $this->_ref = new Pdf\Element\Null();
            return;
        }
