...
class FitRectangle extends Explicit
{
    ...
    public static function create($page, $left, $bottom, $right, $top)
    {
        ...
        $destinationArray->items[] = new Element\Name('FitR');
        $destinationArray->items[] = new Element\Numeric($left);
        $destinationArray->items[] = new Element\Numeric($bottom);
        $destinationArray->items[] = new Element\Numeric($right);
        $destinationArray->items[] = new Element\Numeric($top);

        return new FitRectangle($destinationArray);
    }
    ...
    {
        $this->_destinationArray->items[3] = new Element\Numeric($bottom);
        return $this;
    }
    ...
    {
        $this->_destinationArray->items[4] = new Element\Numeric($right);
        return $this;
    }
    ...
    {
        $this->_destinationArray->items[5] = new Element\Numeric($top);
        return $this;
    }
}
