 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Named extends Destination
{
    /**
     * Destination name
     *
     ...
     */
    public function __construct(Element\Element $resource)
    {
        if ($resource->getType() != Element\Element::TYPE_NAME  &&  $resource->getType() != Element\Element::TYPE_STRING) {
            require_once 'Zend/Pdf/Exception.php';
            throw new \Zend\Pdf\Exception('Named destination resource must be a PDF name or a PDF string.');
        }
    ...
    {
        return new Named(new Element\String\String($name));
    }
