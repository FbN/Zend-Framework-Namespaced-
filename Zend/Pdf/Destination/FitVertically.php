...
class FitVertically extends Explicit
{
    ...
    public static function create($page, $left)
    {
        ...
        if ($page instanceof \Zend\Pdf\Page) {
            ...
            throw new \Zend\Pdf\Exception('Page entry must be a Zend_Pdf_Page object or page number.');
        }

        $destinationArray->items[] = new Element\Name('FitV');
        $destinationArray->items[] = new Element\Numeric($left);

        return new FitVertically($destinationArray);
    }
