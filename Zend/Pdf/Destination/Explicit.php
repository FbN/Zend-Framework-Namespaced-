 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Explicit extends Destination
{
    /**
     ...
     */
    public function __construct(Element\Element $destinationArray)
    {
        if ($destinationArray->getType() != Element\Element::TYPE_ARRAY) {
        ...
        switch ($this->_destinationArray->items[0]->getType()) {
            case Element\Element::TYPE_NUMERIC:
                $this->_isRemote = true;
                break;
