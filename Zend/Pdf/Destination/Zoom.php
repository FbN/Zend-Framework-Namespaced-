...
class Zoom extends Explicit
{
    ...
    public static function create($page, $left = null, $top = null, $zoom = null)
    {
        ...
        $destinationArray->items[] = new Element\Name('XYZ');

        if ($left === null) {
            $destinationArray->items[] = new Element\Null();
        } else {
            $destinationArray->items[] = new Element\Numeric($left);
        }
        ...
        if ($zoom === null) {
            ...
            $destinationArray->items[] = new Element\Numeric($zoom);
        }

        return new Zoom($destinationArray);
    }
    ...
    {
        if ($left === null) {
            $this->_destinationArray->items[2] = new Element\Null();
        } else {
            $this->_destinationArray->items[2] = new Element\Numeric($left);
        }
    ...
    {
        if ($top === null) {
            $this->_destinationArray->items[3] = new Element\Null();
        } else {
            $this->_destinationArray->items[3] = new Element\Numeric($top);
        }
    ...
    {
        if ($zoom === null) {
            $this->_destinationArray->items[4] = new Element\Null();
        } else {
            $this->_destinationArray->items[4] = new Element\Numeric($zoom);
        }
