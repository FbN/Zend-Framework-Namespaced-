...
class NameTree implements \ArrayAccess, \Iterator, \Countable
{
     ...
     */
    public function __construct(Element\Element $rootDictionary)
    {
        if ($rootDictionary->getType() != Element\Element::TYPE_DICTIONARY) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Exception('Name tree root must be a dictionary.');
        }
