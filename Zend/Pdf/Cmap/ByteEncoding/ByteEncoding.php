 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ByteEncoding extends Cmap\Cmap
{
  /**** Instance Variables ****/
  ...
  /* Concrete Class Implementation */
    ...
    public function glyphNumbersForCharacters($characterCodes)
    {
        ...
        foreach ($characterCodes as $key => $characterCode) {
           ...
           if (! isset($this->_glyphIndexArray[$characterCode])) {
                $glyphNumbers[$key] = Cmap\Cmap::MISSING_CHARACTER_GLYPH;
                continue;
            }
    ...
    {
        if (! isset($this->_glyphIndexArray[$characterCode])) {
            return Cmap\Cmap::MISSING_CHARACTER_GLYPH;
        }
  ...
  /* Object Lifecycle */
    ...
    public function __construct($cmapData)
    {
        ...
        if ($type != Cmap\Cmap::TYPE_BYTE_ENCODING) {
            require_once 'Zend/Pdf/Exception.php';
