 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Image extends \Zend\Pdf\Resource\Resource
{
    /**
     * Object constructor.
     */
    public function __construct()
    {
        ...
        $this->_resource->dictionary->Type    = new Element\Name('XObject');
        $this->_resource->dictionary->Subtype = new Element\Name('Image');
    }
    /**
