 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ContentStream extends Resource
{
    /**
     * Buffered content
     *
    ...
    public function __construct($contentStreamObject = '')
    {
        if ($contentStreamObject !== null &&
            !$contentStreamObject instanceof \Zend\Pdf\Element\Object\Stream &&
            !is_string($contentStreamObject)
        ) {
            require_once 'Zend/Pdf/Exception.php';
            throw new \Zend\Pdf\Exception('Content stream parameter must be a string or stream object');
        }
