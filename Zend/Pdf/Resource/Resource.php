...
abstract class Resource
{
    ...
    {
        if ($resource instanceof \Zend\Pdf\Element\Object\Object) {
        ...
        $this->_objectFactory = \Zend\Pdf\ElementFactory\ElementFactory::createFactory(1);
        if ($resource instanceof \Zend\Pdf\Element\Element) {
