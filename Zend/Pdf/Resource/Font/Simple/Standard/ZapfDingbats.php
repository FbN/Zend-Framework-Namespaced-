 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZapfDingbats extends Standard
{
  /**** Instance Variables ****/
  ...
  /* Object Lifecycle */
    ...
    public function __construct()
    {
        ...
        $this->_cmap = Cmap\Cmap::cmapWithTypeData(
            Cmap\Cmap::TYPE_BYTE_ENCODING_STATIC, $cmapData);
         ...
         */
        $this->_resource->BaseFont = new Pdf\Element\Name('ZapfDingbats');
