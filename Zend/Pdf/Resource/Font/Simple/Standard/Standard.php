 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Standard extends \Zend\Pdf\Resource\Font\Simple\Simple
{
  /**** Public Interface ****/
  ...
  /* Object Lifecycle */
    ...
    {
        $this->_fontType = \Zend\Pdf\Font::TYPE_STANDARD;

        parent::__construct();
        $this->_resource->Subtype  = new \Zend\Pdf\Element\Name('Type1');
    }
}
