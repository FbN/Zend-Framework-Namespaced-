 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Parsed extends \Zend\Pdf\Resource\Font\Simple\Simple
{
    /**
     * Object constructor
     *
     ...
     */
    public function __construct(\Zend\Pdf\FileParser\Font\OpenType\OpenType $fontParser)
    {
        parent::__construct();
        ...
        $baseFont = $this->getFontName(\Zend\Pdf\Font::NAME_POSTSCRIPT, 'en', 'UTF-8');
        $this->_resource->BaseFont = new Element\Name($baseFont);

        $this->_resource->FirstChar = new Element\Numeric(0);
        $this->_resource->LastChar  = new Element\Numeric(count($this->_glyphWidths) - 1);
         ...
         */
        $widthsArrayElement = new Element\Array($pdfWidths);
