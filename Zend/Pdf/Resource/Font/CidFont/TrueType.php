 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class TrueType extends CidFont
{
    /**
     * Object constructor
     *
    ...
    public function __construct(\Zend\Pdf\FileParser\Font\OpenType\TrueType $fontParser, $embeddingOptions)
    {
        ...
        $this->_fontType = \Zend\Pdf\Font::TYPE_CIDFONT_TYPE_2;

        $this->_resource->Subtype  = new Element\Name('CIDFontType2');
        ...
        $cidToGidMap->dictionary->Filter = new Element\Name('FlateDecode');
