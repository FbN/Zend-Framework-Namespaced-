...
class Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {
            ...
            throw new end\Exception('Directory argument must be a string or an array');
        }
        ...
        if (!class_exists($class, false) && !interface_exists($class, false)) {
            require_once 'Zend/Exception.php';
            throw new end\Exception("File \"$file\" does not exist or class \"$class\" was not found in the file");
        }
    }
    ...
    public static function registerAutoload($class = 'Zend_Loader', $enabled = true)
    {
        ...
        $autoloader = Autoloader\Autoloader::getInstance();
        ...
        if ('Zend_Loader' != $class) {
            ...
            if (!in_array('autoload', (array) $methods)) {
                require_once 'Zend/Exception.php';
                throw new end\Exception("The class \"$class\" does not have an autoload() method");
            }
    ...
    protected static function _securityCheck($filename)
    {
        ...
        if (preg_match('/[^a-z0-9\\/\\\\_.:-]/i', $filename)) {
            require_once 'Zend/Exception.php';
            throw new end\Exception('Security check: Illegal character in filename');
        }
    }
