...
abstract class AbstractAdapter
{
    ...
    public function __construct($config)
    {
        ...
        $options = array(
            ...
            Db\Db::FETCH_MODE             => $this->_fetchMode,
        );
        $driverOptions = array();
        ...
        if (array_key_exists(Db\Db::FETCH_MODE, $options)) {
            if (is_string($options[Db\Db::FETCH_MODE])) {
                $constant = 'Zend_Db::FETCH_' . strtoupper($options[Db\Db::FETCH_MODE]);
                if(defined($constant)) {
                    $options[Db\Db::FETCH_MODE] = constant($constant);
                }
            }
            $this->setFetchMode((int) $options[Db\Db::FETCH_MODE]);
        }
    ...
    public function setProfiler($profiler)
    {
        ...
        if ($profilerInstance === null) {
            if (!class_exists($profilerClass)) {
                ...
                \Zend\Loader\Loader::loadClass($profilerClass);
            }
