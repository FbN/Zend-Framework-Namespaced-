...
abstract class AbstractRow implements \ArrayAccess, \IteratorAggregate
{
                                         ...
                                         $matchRefRule = null, Select\Select $select = null)
    {
        ...
        $select->from(array('i' => $interName), array(), $interSchema)
               ->joinInner(array('m' => $matchName), $joinCond, end\Db\Select\Select::SQL_WILDCARD, $matchSchema)
    ...
    protected function _getTableFromString($tableName)
    {
        ...
        if ($this->_table instanceof Table\AbstractTable) {
            ...
            if ($tableDefinition !== null && $tableDefinition->hasTableConfig($tableName)) {
                return new end\Db\Table\Table($tableName, $tableDefinition);
            }
        }
        ...
        if (!class_exists($tableName)) {
            try {
                require_once 'Zend/Loader.php';
                Loader\Loader::loadClass($tableName);
            } catch (end\Exception $e) {
                require_once 'Zend/Db/Table/Row/Exception.php';
                throw new Exception($e->getMessage(), $e->getCode(), $e);
            }
