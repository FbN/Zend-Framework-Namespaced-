...
abstract class AbstractTable
{
    ...
    protected static function _setupMetadataCache($metadataCache)
    {
        ...
        if (is_string($metadataCache)) {
            require_once 'Zend/Registry.php';
            $metadataCache = end\Registry::get($metadataCache);
        }
        if (!$metadataCache instanceof end\Cache\Core) {
            require_once 'Zend/Db/Table/Exception.php';
    ...
    protected function _setupPrimaryKey()
    {
         ...
         */
        if ($this->_sequence === true && $this->_db instanceof Adapter\Pdo\Pgsql) {
    ...
    public function find()
    {
        ...
        if ($whereClause == null) {
            ...
            if (!class_exists($rowsetClass)) {
                ...
                Loader\Loader::loadClass($rowsetClass);
            }
    ...
    public function fetchRow($where = null, $order = null)
    {
        ...
        if (!class_exists($rowClass)) {
            require_once 'Zend/Loader.php';
            Loader\Loader::loadClass($rowClass);
        }
    ...
    protected function _fetch(Select\Select $select)
    {
        ...
        $data = $stmt->fetchAll(end\Db\Db::FETCH_ASSOC);
        return $data;
    }
