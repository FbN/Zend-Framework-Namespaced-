...
class Currency
{
    ...
    public function getRegionList($currency = null)
    {
        ...
        $data = Data\Data::getContent($this->_options['locale'], 'regiontocurrency', $currency);
    ...
    public function getCurrencyList($region = null)
    {
        ...
        $data = Data\Data::getContent($this->_options['locale'], 'currencytoregion', $region);
    ...
    protected function _exchangeCurrency($value, $currency)
    {
        ...
        if ($currency !== $this->getShortName()) {
            ...
            if (!($service instanceof CurrencyInterface)) {
                require_once 'Zend/Currency/Exception.php';
    ...
    public function setService($service)
    {
        if (is_string($service)) {
            ...
            if (!class_exists($service)) {
                ...
                if (Loader\Loader::isReadable($file)) {
                    Loader\Loader::loadClass($class);
                }
            }
        ...
        if (!($service \instanceof CurrencyInterface)) {
            require_once 'Zend/Currency/Exception.php';
            throw new Exception('A currency service must implement Zend_Currency_CurrencyInterface');
        }
