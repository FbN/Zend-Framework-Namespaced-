...
class Model extends AbstractProvider
{
    ...
    public static function createResource(Profile\Profile $profile, $modelName, $moduleName = null)
    {
     ...
     */
    public static function hasResource(Profile\Profile $profile, $modelName, $moduleName = null)
    {
        if (!is_string($modelName)) {
        ...
        return (($modelsDirectory->search(array('modelFile' => array('modelName' => $modelName)))) instanceof Profile\Resource\Resource);
    }
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    protected static function _getModelsDirectoryResource(Profile\Profile $profile, $moduleName = null)
    {
