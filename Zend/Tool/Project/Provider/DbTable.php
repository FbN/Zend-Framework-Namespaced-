    ...
    implements \Zend\Tool\Framework\Provider\Pretendable
{
    ...
    public static function createResource(Profile\Profile $profile, $dbTableName, $actualTableName, $moduleName = null)
    {
        ...
        if (!($modelsDirectory instanceof Resource\Resource)) {
            throw new Exception(
    ...
    public static function hasResource(Profile\Profile $profile, $dbTableName, $moduleName = null)
    {
        $profileSearchParams = array();
        ...
        return ($dbTableFile instanceof Resource\Resource) ? true : false;
    }
    ...
    protected function _convertTableNameToClassName($tableName)
    {
        if ($this->_nameFilter == null) {
            $this->_nameFilter = new \Zend\Filter\Filter();
            $this->_nameFilter
