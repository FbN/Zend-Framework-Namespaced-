...
class Form extends AbstractProvider
{
    ...
    public static function createResource(Profile\Profile $profile, $formName, $moduleName = null)
    {
     ...
     */
    public static function hasResource(Profile\Profile $profile, $formName, $moduleName = null)
    {
        if (!is_string($formName)) {
        ...
        return (($formsDirectory->search(array('formFile' => array('formName' => $formName)))) instanceof Profile\Resource\Resource);
    }
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    protected static function _getFormsDirectoryResource(Profile\Profile $profile, $moduleName = null)
    {
    ...
    public function enable($module = null)
    {
        ...
        if ($formDirectoryResource->isEnabled()) {
            throw new Exception('This project already has forms enabled.');
        } else {
