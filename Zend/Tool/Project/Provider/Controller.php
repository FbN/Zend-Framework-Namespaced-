    ...
    implements \Zend\Tool\Framework\Provider\Pretendable
{
     ...
     */
    public static function createResource(Profile\Profile $profile, $controllerName, $moduleName = null)
    {
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    public static function hasResource(Profile\Profile $profile, $controllerName, $moduleName = null)
    {
        if (!is_string($controllerName)) {
            throw new Exception('Zend_Tool_Project_Provider_Controller::createResource() expects \"controllerName\" is the name of a controller resource to create.');
        }
        ...
        return (($controllersDirectory->search(array('controllerFile' => array('controllerName' => $controllerName)))) instanceof Profile\Resource\Resource);
    }
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    protected static function _getControllersDirectoryResource(Profile\Profile $profile, $moduleName = null)
    {
