    ...
    implements \Zend\Tool\Framework\Provider\Pretendable
{
     ...
     */
    public static function createResource(Profile\Profile $profile, $actionName, $controllerName, $moduleName = null)
    {
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    public static function hasResource(Profile\Profile $profile, $actionName, $controllerName, $moduleName = null)
    {
        if (!is_string($actionName)) {
            throw new Exception('Zend_Tool_Project_Provider_Action::createResource() expects \"actionName\" is the name of a action resource to create.');
        }
        ...
        return (($controllerFile->search(array('actionMethod' => array('actionName' => $actionName)))) instanceof Profile\Resource\Resource);
    }
     ...
     * @return Zend_Tool_Project_Profile_Resource
     */
    protected static function _getControllerFileResource(Profile\Profile $profile, $controllerName, $moduleName = null)
    {
