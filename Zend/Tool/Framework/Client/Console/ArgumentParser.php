 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ArgumentParser implements \Zend\Tool\Framework\Registry\EnabledInterface
{
    ...
    protected function _parseGlobalPart()
    {
        ...
        $getoptParser = new Getopt\Getopt($getoptOptions, $this->_argumentsWorking, array('parseAll' => false));
