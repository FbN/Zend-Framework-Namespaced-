...
class Doctype extends AbstractHelper
{
    ...
    {
        if (!end\Registry::isRegistered($this->_regKey)) {
            ...
            end\Registry::set($this->_regKey, $this->_registry);
            $this->setDoctype($this->_defaultDoctype);
        } else {
            $this->_registry = end\Registry::get($this->_regKey);
        }
    }
            ...
            switch ($doctype) {
                ...
                default:
                    if (substr($doctype, 0, 9) != '<!DOCTYPE') {
                        ...
                        $e = new end\View\Exception('The specified doctype is malformed');
                        $e->setView($this->view);
                        throw $e;
                    }
