...
class HeadScript extends Placeholder\Container\Standalone
{
     ...
     */
    public function headScript($mode = HeadScriptHeadScript::FILE, $spec = null, $placement = 'APPEND', array $attrs = array(), $type = 'text/javascript')
    {
     ...
     * @return void
     */
    public function captureStart($captureType = Placeholder\Container\AbstractContainerPlaceholder\Container\AbstractContainer::APPEND, $type = 'text/javascript', $attrs = array())
    {
