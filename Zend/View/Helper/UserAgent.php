 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UserAgent extends AbstractHelper
{
    /**
     ...
     */
    public function userAgent(UserAgent\UserAgent $userAgent = null)
    {
        if (null !== $userAgent) {
     ...
     */
    public function setUserAgent(UserAgent\UserAgent $userAgent)
    {
