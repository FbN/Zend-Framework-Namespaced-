...
class HeadTitle extends Placeholder\Container\Standalone
{
    ...
    public function setDefaultAttachOrder($setType)
    {
        if (!in_array($setType, array(
            ...
            throw new View\Exception("You must use a valid attach order: 'PREPEND', 'APPEND' or 'SET'");
        }
    ...
    {
        if ($translate instanceof end\Translate\Adapter\Adapter) {
            $this->_translator = $translate;
        } elseif ($translate instanceof end\Translate\Translate) {
