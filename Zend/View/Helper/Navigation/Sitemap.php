    ...
    extends HelperAbstract
{
    ...
    public function getDomSitemap(Navigation\Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            ...
            // create validators
            $locValidator        = new \Zend\Validate\Sitemap\Loc();
            $lastmodValidator    = new \Zend\Validate\Sitemap\Lastmod();
            $changefreqValidator = new \Zend\Validate\Sitemap\Changefreq();
            $priorityValidator   = new \Zend\Validate\Sitemap\Priority();
        }
