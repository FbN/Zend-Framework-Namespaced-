    ...
    implements Helper
{
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            if (end\Registry::isRegistered('Zend_Navigation')) {
                $nav = end\Registry::get('Zend_Navigation');
            ...
            $this->_container = new end\Navigation\Navigation();
        }
    ...
    {
        if (null == $translator ||
            $translator instanceof end\Translate\Adapter\Adapter) {
            $this->_translator = $translator;
        } elseif ($translator instanceof end\Translate\Translate) {
    ...
    public function getTranslator()
    {
        if (null === $this->_translator) {
            ...
            if (end\Registry::isRegistered('Zend_Translate')) {
                $this->setTranslator(end\Registry::get('Zend_Translate'));
            }
        }
    ...
    public function setRole($role = null)
    {
        if (null === $role || is_string($role) ||
            $role instanceof Role\RoleInterface) {
            $this->_role = $role;
        } else {
