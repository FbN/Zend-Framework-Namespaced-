...
class Registry
{
    ...
    public function createContainer($key, array $value = array())
    {
        ...
        $this->_items[$key] = new $this->\\containerClass(array());
     ...
     */
    public function setContainer($key, end\View\Helper\Placeholder\Container\AbstractContainer $container)
    {
        $key = (string) $key;
    ...
    public function setContainerClass($name)
    {
        if (!class_exists($name)) {
            ...
            end\Loader\Loader::loadClass($name);
        }
