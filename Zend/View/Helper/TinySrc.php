 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class TinySrc extends HtmlElement
{
    ...
    public function setDefaultFormat($format = null)
    {
        ...
        if (!in_array($format, array('png', 'jpeg'))) {
            ...
            throw new View\Exception('Invalid format; must be one of "jpeg" or "png"');
        }
        $this->_format = "/$format";
        return $this;
    }
    ...
    public function setDefaultDimensions($width = null, $height = null)
    {
        ...
        if (!$this->_validateDimension($width)) {
            require_once 'Zend/View/Exception.php';
            throw new View\Exception('Invalid dimension; must be an integer, optionally preceded by "-" or "x"');
        }
