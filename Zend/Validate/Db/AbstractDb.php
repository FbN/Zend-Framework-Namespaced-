 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class AbstractDb extends Validate\AbstractValidate
{
    /**
     * Error constants
     */
    ...
    {
        if ($options instanceof Select\Select) {
        ...
        if (!array_key_exists('table', $options) && !array_key_exists('schema', $options)) {
            ...
            throw new Validate\Exception('Table or Schema option missing!');
        }

        if (!array_key_exists('field', $options)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception('Field option missing!');
        }
    ...
    public function getAdapter()
    {
        ...
        if ($this->_adapter === null) {
            ...
            if (null === $this->_adapter) {
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception('No database adapter present');
            }
        }
    ...
    public function setAdapter($adapter)
    {
        if (!($adapter instanceof \Zend\Db\Adapter\AbstractAdapter)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception('Adapter option must be a database adapter!');
        }
    ...
    public function setSelect($select)
    {
        if (!$select instanceof Select\Select) {
            throw new Validate\Exception('Select option must be a valid ' .
