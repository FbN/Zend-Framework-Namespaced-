 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Count extends Validate\AbstractValidate
{
    /**#@+
    ...
    public function setMin($min)
    {
        ...
        if (($this->_max !== null) && ($min > $this->_max)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception("The minimum must be less than or equal to the maximum file count, but $min >"
                                            . " {$this->_max}");
        }
    ...
    public function setMax($max)
    {
        ...
        if (($this->_min !== null) && ($max < $this->_min)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception("The maximum must be greater than or equal to the minimum file count, but "
                                            . "$max < {$this->_min}");
        }
