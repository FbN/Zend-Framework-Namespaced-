 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class MimeType extends Validate\AbstractValidate
{
    /**#@+
    ...
    public function setMagicFile($file)
    {
        if (empty($file)) {
            ...
            $this->_magicfile = null;
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception('Magicfile can not be set. There is no finfo extension installed');
        } else if (!is_file($file) || !is_readable($file)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception('The given magicfile can not be read');
        } else {
            ...
            if (empty($this->_finfo)) {
                $this->_finfo = null;
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception('The given magicfile is not accepted by finfo');
            } else {
