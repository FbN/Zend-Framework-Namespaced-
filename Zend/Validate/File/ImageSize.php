 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class ImageSize extends Validate\AbstractValidate
{
    /**
    ...
    public function __construct($options)
    {
        if ($options instanceof \Zend\Config\Config) {
            ...
            throw new Validate\Exception ('Invalid options to validator provided');
        }
    ...
    public function setImageMin($options)
    {
        if (isset($options['minwidth'])) {
            if (($this->_maxwidth !== null) and ($options['minwidth'] > $this->_maxwidth)) {
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception("The minimum image width must be less than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_maxheight !== null) and ($options['minheight'] > $this->_maxheight)) {
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception("The minimum image height must be less than or equal to the "
    ...
    public function setImageMax($options)
    {
        if (isset($options['maxwidth'])) {
            if (($this->_minwidth !== null) and ($options['maxwidth'] < $this->_minwidth)) {
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception("The maximum image width must be greater than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_minheight !== null) and ($options['maxheight'] < $this->_minheight)) {
                require_once 'Zend/Validate/Exception.php';
                throw new Validate\Exception("The maximum image height must be greater than or equal to the "
    ...
    public function isValid($value, $file = null)
    {
        ...
        if (!\Zend\Loader\Loader::isReadable($value)) {
