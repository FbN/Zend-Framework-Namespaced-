 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Size extends Validate\AbstractValidate
{
    /**#@+
    ...
    public function setMin($min)
    {
        ...
        if (($max !== null) && ($min > $max)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception("The minimum must be less than or equal to the maximum filesize, but $min >"
                                            . " $max");
        }
    ...
    public function setMax($max)
    {
        ...
        if (($min !== null) && ($max < $min)) {
            require_once 'Zend/Validate/Exception.php';
            throw new Validate\Exception("The maximum must be greater than or equal to the minimum filesize, but "
                                            . "$max < $min");
        }
