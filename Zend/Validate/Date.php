 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Date extends AbstractValidate
{
    ...
    public function __construct($options = array())
    {
        ...
        if (!array_key_exists('locale', $options)) {
            ...
            if (end\Registry::isRegistered('Zend_Locale')) {
                $options['locale'] = end\Registry::get('Zend_Locale');
            }
        }
    ...
    public function setLocale($locale = null)
    {
        ...
        $this->_locale = end\Locale\Locale::findLocale($locale);
        return $this;
    }
    ...
    public function isValid($value)
    {
        ...
        if (($this->_format !== null) || ($this->_locale !== null) || is_array($value) ||
            ...
            if (!Date\Date::isDate($value, $this->_format, $this->_locale)) {
    ...
    private function _checkFormat($value)
    {
        try {
            ...
            $parsed = end\Locale\Format::getDate($value, array(
            ...
            if (isset($parsed['year']) and ((strpos(strtoupper($this->_format), 'YY') !== false) and
                ...
                $parsed['year'] = Date\Date::getFullYear($parsed['year']);
            }
        } catch (\Exception $e) {
