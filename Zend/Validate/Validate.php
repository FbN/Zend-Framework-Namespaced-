...
class Validate implements ValidateInterface
{
    ...
    public static function getMessageLength()
    {
        ...
        return AbstractValidate::getMessageLength();
    }
    ...
    {
        require_once 'Zend/Validate/Abstract.php';
        AbstractValidate::setMessageLength($length);
    }
    ...
    {
        require_once 'Zend/Validate/Abstract.php';
        return AbstractValidate::getDefaultTranslator();
    }
    ...
    {
        require_once 'Zend/Validate/Abstract.php';
        AbstractValidate::setDefaultTranslator($translator);
    }
}
