 ...
 * @namespace
 */
namespace Zend\Validate\Barcode;
use Zend\Validate;
use Zend\Loader;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Barcode extends Validate\AbstractValidate
{
    ...
    public function __construct($adapter)
    {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                throw new Validate\Exception("Missing option 'adapter'");
            }
        }
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once 'Zend/Loader.php';
        if (Loader\Loader::isReadable('Zend/Validate/Barcode/' . $adapter. '.php')) {
