...
class Acl
{
     ...
     * @return Zend_Acl Provides a fluent interface
     */
    public function add(Resource\ResourceInterface $resource, $parent = null)
    {
     ...
     * @return Zend_Acl Provides a fluent interface
     */
    public function allow($roles = null, $resources = null, $privileges = null, Assert\AssertInterface $assert = null)
    {
     ...
     * @return Zend_Acl Provides a fluent interface
     */
    public function deny($roles = null, $resources = null, $privileges = null, Assert\AssertInterface $assert = null)
    {
    ...
    public function setRule($operation, $type, $roles = null, $resources = null, $privileges = null,
                            Assert\AssertInterface $assert = null)
    {
    ...
    protected function _getRoleRegistry()
    {
        if (null === $this->_roleRegistry) {
            $this->_roleRegistry = new Role\Registry\Registry();
        }
     ...
     * @throws Zend_Acl_Exception
     */
    protected function _roleDFSVisitAllPrivileges(Role\RoleInterface $role, Resource\ResourceInterface $resource = null,
                                                 &$dfs = null)
    {
        if (null === $dfs) {
            /**
     ...
     * @throws Zend_Acl_Exception
     */
    protected function _roleDFSOnePrivilege(Role\RoleInterface $role, Resource\ResourceInterface $resource = null,
                                            $privilege = null)
    {
        if (null === $privilege) {
            /**
     ...
     * @return string|null
     */
    protected function _getRuleType(Resource\ResourceInterface $resource = null, Role\RoleInterface $role = null,
                                    $privilege = null)
    {
     ...
     * @return array|null
     */
    protected function &_getRules(Resource\ResourceInterface $resource = null, Role\RoleInterface $role = null,
                                  $create = false)
    {
