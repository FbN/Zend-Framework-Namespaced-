    ...
    public function prepareSlider($id, $value = null, array $params = array(), array $attribs = array())
    {
        ...
        foreach ($this->_requiredParams as $param) {
            if (!array_key_exists($param, $params)) {
                ...
                throw new View\Exception('prepareSlider() requires minimally the "minimum", "maximum", and "discreteValues" parameters');
            }
        }
        ...
        switch ($this->_sliderType) {
            ...
            default:
                require_once 'Zend/Dojo/View/Exception.php';
                throw new View\Exception('Invalid slider type; slider must be horizontal or vertical');
        }
