 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
abstract class Dijit extends \Zend\View\Helper\HtmlElement
{
    /**
    ...
    {
        return Dojo\Dojo::useDeclarative();
    }
    ...
    {
        return Dojo\Dojo::useProgrammatic();
    }
    ...
    {
        return Dojo\Dojo::useProgrammaticNoScript();
    }
    ...
    protected function _prepareDijit(array $attribs, array $params, $type, $dijit = null)
    {
        ...
        foreach ($this->_jsonParams as $param) {
            if (array_key_exists($param, $params)) {
                ...
                $values = \Zend\Json\Json::encode($values);
