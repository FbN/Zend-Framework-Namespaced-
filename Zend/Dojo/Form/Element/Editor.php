...
class Editor extends Dijit
{
    ...
    public function setHeight($height)
    {
        if (!preg_match('/^\d+(em|px|%)?$/i', $height)) {
            ...
            throw new Element\Exception('Invalid height provided; must be integer or CSS measurement');
        }
    ...
    public function setMinHeight($minHeight)
    {
        if (!preg_match('/^\d+(em)?$/i', $minHeight)) {
            require_once 'Zend/Form/Element/Exception.php';
            throw new Element\Exception('Invalid minHeight provided; must be integer or CSS measurement');
        }
