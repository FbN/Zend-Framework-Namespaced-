 ...
 */
class DijitElement extends \Zend\Form\Decorator\ViewHelper
{
    /**
     * Element attributes
     * @var array
    ...
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new \Zend\Form\Decorator\Exception('DijitElement decorator cannot render without a registered view object');
        }
