 ...
 */
class Form implements \Iterator, \Countable, end\Validate\ValidateInterface
{
    /**#@+
    ...
    public function setOptions(array $options)
    {
        ...
        foreach ($options as $key => $value) {
            ...
            if (method_exists($this, $method)) {
                if($normalized == 'View' && !($value instanceof View\ViewInterface)) {
                    continue;
                }
                $this->$method($value);
            } else {
     ...
     */
    public function setPluginLoader(end\Loader\PluginLoader\PluginLoaderInterface $loader, $type = null)
    {
    ...
    public function addElement($element, $name = null, $options = null)
    {
        ...
        } elseif ($element instanceof Element\Element) {
            $prefixPaths              = array();
    ...
    public function addElements(array $elements)
    {
        foreach ($elements as $key => $spec) {
            ...
            if (is_string($spec) || ($spec instanceof Element\Element)) {
    ...
    public function addDisplayGroup(array $elements, $name, $options = null)
    {
        ...
        if (!class_exists($class)) {
            ...
            end\Loader\Loader::loadClass($class);
        }
    ...
    public function getElementsAndSubFormsOrdered()
    {
        ...
        foreach ($this->_order as $name => $order) {
            ...
            if ($this->$name instanceof Element\Element ||
                $this->$name instanceof Form) {
    ...
    public function processAjax(array $data)
    {
        ...
        if ($this->isValidPartial($data)) {
            return Json\Json::encode(true);
        }
        $messages = $this->getMessages();
        return Json\Json::encode($messages);
    }
    ...
    public function getView()
    {
        if (null === $this->_view) {
            ...
            $viewRenderer = end\Controller\Action\HelperBroker\HelperBroker::getStaticHelper('viewRenderer');
    ...
    public function setTranslator($translator = null)
    {
        ...
        } elseif ($translator instanceof Adapter\Adapter) {
