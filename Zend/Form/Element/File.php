...
class File extends Xhtml
{
    ...
    {
        if ($adapter instanceof \Zend\File\Transfer\Adapter\AbstractAdapter) {
    ...
    public function getTranslator()
    {
        ...
        if (null === $translator) {
            ...
            return \Zend\Form\Form::getDefaultTranslator();
        }
     ...
     * @return string
     */
    public function render(\Zend\View\ViewInterface $view = null)
    {
        $marker = false;
        foreach ($this->getDecorators() as $decorator) {
            if ($decorator instanceof \Zend\Form\Decorator\Marker\File\FileInterface) {
                $marker = true;
            }
        }
        ...
        if (!$marker) {
            require_once 'Zend/Form/Element/Exception.php';
            throw new Exception('No file decorator found... unable to render file element');
        }
