...
class Label extends AbstractDecorator
{
    ...
    public function __call($method, $args)
    {
        ...
        if (in_array($head, array('get', 'set'))
            ...
            switch ($type) {
                ...
                default:
                    ...
                    throw new Form\Exception(sprintf('Invalid method "%s" called in Label decorator, and detected as type %s', $method, $type));
            }
            ...
            switch ($head) {
                case 'set':
                    if (0 === count($args)) {
                        require_once 'Zend/Form/Exception.php';
                        throw new Form\Exception(sprintf('Method "%s" requires at least one argument; none provided', $method));
                    }
        ...
        require_once 'Zend/Form/Exception.php';
        throw new Form\Exception(sprintf('Invalid method "%s" called in Label decorator', $method));
    }
