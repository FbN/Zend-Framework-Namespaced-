...
class FormErrors extends AbstractDecorator
{
     ...
     * @return string
     */
    public function renderLabel(Element\Element $element, View\ViewInterface $view)
    {
     ...
     * @return string
     */
    protected function _recurseForm(Form\Form $form, View\ViewInterface $view)
    {
        $content = '';
        ...
        foreach ($form->getElementsAndSubFormsOrdered() as $subitem) {
            if ($subitem instanceof Element\Element && !$this->getOnlyCustomFormErrors()) {
            ...
            } else if ($subitem instanceof Form\Form && !$this->ignoreSubForms()) {
