...
class DisplayGroup implements \Iterator,\Countable
{
     ...
     * @return void
     */
    public function __construct($name, PluginLoader\PluginLoader $loader, $options = null)
    {
        $this->setName($name);
     ...
     * @return Zend_Form_DisplayGroup
     */
    public function setPluginLoader(PluginLoader\PluginLoader $loader)
    {
        $this->_loader = $loader;
        return $this;
    }
    ...
    {
        if ((null === $translator) || ($translator instanceof \Zend\Translate\Adapter\Adapter)) {
