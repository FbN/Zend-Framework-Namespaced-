...
class Json extends AdapterAbstract
{
    ...
    public function serialize($value, array $opts = array())
    {
        ...
        try  {
            return Json\Json::encode($value, $opts['cycleCheck'], $opts);
        } catch (\Exception $e) {
            require_once 'Zend/Serializer/Exception.php';
            throw new Serializer\Exception('Serialization failed', 0, $e);
        }
    }
    ...
    public function unserialize($json, array $opts = array())
    {
        ...
        try {
            $ret = Json\Json::decode($json, $opts['objectDecodeType']);
        } catch (\Exception $e) {
            require_once 'Zend/Serializer/Exception.php';
        ...
        if ($ret === null && $json !== 'null') {
            require_once 'Zend/Serializer/Exception.php';
            throw new Serializer\Exception('Invalid json data');
        }
