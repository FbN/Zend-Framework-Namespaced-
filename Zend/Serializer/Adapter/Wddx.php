 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Wddx extends AdapterAbstract
{
    /**
    ...
    public function __construct($opts = array())
    {
        if (!extension_loaded('wddx')) {
            ...
            throw new Serializer\Exception('PHP extension "wddx" is required for this adapter');
        }
    ...
    public function serialize($value, array $opts = array())
    {
        ...
        if ($wddx === false) {
            ...
            require_once 'Zend/Serializer/Exception.php';
            throw new Serializer\Exception($lastErr['message']);
        }
        return $wddx;
    }
    ...
    public function unserialize($wddx, array $opts = array())
    {
        ...
        if ($ret === null) {
            ...
            require_once 'Zend/Serializer/Exception.php';
            throw new Serializer\Exception($errMsg);
        }
