...
class DocumentWriter extends SegmentWriter
{
     ...
     * @param string $name
     */
    public function __construct(\Zend\Search\Lucene\Storage\Directory\Directory $directory, $name)
    {
     ...
     */
    public function addDocument(\Zend\Search\Lucene\Document\Document $document)
    {
        ...
        $storedFields = array();
        $docNorms     = array();
        $similarity   = \Zend\Search\Lucene\Search\Similarity\Similarity::getDefault();
        ...
        foreach ($document->getFieldNames() as $fieldName) {
            ...
            if ($field->storeTermVector) {
                ...
                throw new \Zend\Search\Lucene\Exception('Store term vector functionality is not supported yet.');
            }
            ...
            if ($field->isIndexed) {
                if ($field->isTokenized) {
                    ...
                    $analyzer = \Zend\Search\Lucene\Analysis\Analyzer\Analyzer::getDefault();
