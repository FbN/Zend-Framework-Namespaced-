...
class SegmentInfo implements TermsStream\TermsStreamInterface
{
     ...
     */
    public function __construct(Lucene\Storage\Directory\Directory $directory, $name, $docCount, $delGen = 0, $docStoreOptions = null, $hasSingleNormFile = false, $isCompound = null)
    {
