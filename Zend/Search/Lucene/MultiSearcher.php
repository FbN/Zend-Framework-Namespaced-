 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class MultiSearcher implements LuceneInterface
{
    /**
    ...
    public function __construct($indices = array())
    {
        ...
        foreach ($this->_indices as $index) {
            if (!$index instanceof LuceneInterface) {
     ...
     */
    public function addIndex(LuceneInterface $index)
    {
        $this->_indices[] = $index;
    }
     ...
     * @throws Zend_Search_Lucene_Exception
     */
    public static function getActualGeneration(Storage\Directory\Directory $directory)
    {
        require_once 'Zend/Search/Lucene/Exception.php';
    ...
    {
        return Lucene::getSegmentFileName($generation);
    }
