...
class Utf8Num extends \Zend\Search\Lucene\Analysis\Analyzer\Common\Common
{
    /**
    ...
    public function __construct()
    {
        if (@preg_match('/\pL/u', 'a') != 1) {
            ...
            throw new \Zend\Search\Lucene\Exception('Utf8Num analyzer needs PCRE unicode support to be enabled.');
        }
    }
    ...
    public function nextToken()
    {
        ...
        do {
            ...
            $token = $this->normalize(new \Zend\Search\Lucene\Analysis\Token($matchedWord, $startPos, $endPos));
