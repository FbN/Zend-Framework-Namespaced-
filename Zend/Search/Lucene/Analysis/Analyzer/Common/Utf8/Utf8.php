...
class Utf8 extends \Zend\Search\Lucene\Analysis\Analyzer\Common\Common
{
    /**
    ...
    public function __construct()
    {
        if (@preg_match('/\pL/u', 'a') != 1) {
            ...
            throw new \Zend\Search\Lucene\Exception('Utf8 analyzer needs PCRE unicode support to be enabled.');
        }
    }
