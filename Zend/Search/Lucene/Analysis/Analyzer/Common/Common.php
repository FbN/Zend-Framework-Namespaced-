 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Common extends \Zend\Search\Lucene\Analysis\Analyzer\Analyzer
{
    /**
     ...
     */
    public function addFilter(\Zend\Search\Lucene\Analysis\TokenFilter\TokenFilter $filter)
    {
     ...
     */
    public function normalize(\Zend\Search\Lucene\Analysis\Token $token)
    {
