...
class QueryParserContext
{
    ...
    public function setNextEntrySign($sign)
    {
        ...
        if ($sign == QueryToken::TT_REQUIRED) {
            ...
            throw new \Zend\Search\Lucene\Exception('Unrecognized sign type.');
        }
    }
     ...
     */
    public function addEntry(QueryEntry\QueryEntry $entry)
    {
        if ($this->_mode !== self::GM_BOOLEAN) {
    ...
    public function processFuzzyProximityModifier($parameter = null)
    {
        ...
        if (!$lastEntry instanceof QueryEntry\QueryEntry) {
    ...
    private function _booleanExpressionQuery()
    {
        ...
        try {
            foreach ($this->_entries as $entry) {
                if ($entry instanceof QueryEntry\QueryEntry) {
                    ...
                    switch ($entry) {
                        ...
                        default:
                            throw new \Zend\Search\Lucene\Lucene('Boolean expression error. Unknown operator type.');
                    }
                }
            }
