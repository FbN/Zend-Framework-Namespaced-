...
class Boolean extends Query
{
     ...
     * @return void
     */
    public function addSubquery(Query $subquery, $sign=null) {
    ...
    public function optimize(Lucene\LuceneInterface $index)
    {
        ...
        $optimizedQuery = new Boolean($subqueries, $signs);
    ...
    public function createWeight(Lucene\LuceneInterface $reader)
    {
        ...
        $this->_weight = new Lucene\Search\Weight\Boolean($this, $reader);
        return $this->_weight;
    }
     ...
     * @return float
     */
    public function _nonConjunctionScore($docId, Lucene\LuceneInterface $reader)
    {
        if ($this->_coord === null) {
            $this->_coord = array();
