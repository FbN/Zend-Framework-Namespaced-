...
class MultiTerm extends Query
{
     ...
     * @return void
     */
    public function addTerm(Lucene\Index\Term $term, $sign = null) {
    ...
    public function createWeight(Lucene\LuceneInterface $reader)
    {
        ...
        $this->_weight = new Lucene\Search\Weight\MultiTerm($this, $reader);
        return $this->_weight;
    }
     ...
     * @param Zend_Search_Lucene_Interface $reader
     */
    private function _calculateConjunctionResult(Lucene\LuceneInterface $reader)
    {
     ...
     * @param Zend_Search_Lucene_Interface $reader
     */
    private function _calculateNonConjunctionResult(Lucene\LuceneInterface $reader)
    {
     ...
     * @return float
     */
    public function _conjunctionScore($docId, Lucene\LuceneInterface $reader)
    {
        if ($this->_coord === null) {
