...
class Fuzzy extends Preprocessing
{
        ...
        if ($this->_field === null) {
            ...
            foreach ($searchFields as $fieldName) {
                ...
                if ( !($rewrittenSubquery instanceof Query\Insignificant  ||
                       $rewrittenSubquery instanceof Query\Empty) ) {
     ...
     */
    protected function _highlightMatches(Search\Highlighter\HighlighterInterface $highlighter)
    {
