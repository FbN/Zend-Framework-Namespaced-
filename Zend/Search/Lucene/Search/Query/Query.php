...
abstract class Query
{
     ...
     * @return float
     */
    abstract public function score($docId, Lucene\LuceneInterface $reader);
     ...
     */
    abstract public function execute(Lucene\LuceneInterface $reader, $docsFilter = null);
     ...
     */
    abstract public function createWeight(Lucene\LuceneInterface $reader);
     ...
     * @param Zend_Search_Lucene_Interface $reader
     */
    protected function _initWeight(Lucene\LuceneInterface $reader)
    {
     ...
     */
    abstract public function rewrite(Lucene\LuceneInterface $index);
     ...
     * @return Zend_Search_Lucene_Search_Query
     */
    abstract public function optimize(Lucene\LuceneInterface $index);
