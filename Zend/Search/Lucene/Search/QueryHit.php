...
class QueryHit
{
    ...
    public function __construct(\Zend\Search\Lucene\LuceneInterface $index)
    {
        require_once 'Zend/Search/Lucene/Proxy.php';
        $this->_index = new \Zend\Search\Lucene\Proxy($index);
    }
    ...
    {
        if (!$this->_document instanceof \Zend\Search\Lucene\Document\Document) {
