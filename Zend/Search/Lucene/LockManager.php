...
class LockManager
{
     ...
     */
    public static function obtainWriteLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @param Zend_Search_Lucene_Storage_Directory $lockDirectory
     */
    public static function releaseWriteLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @throws Zend_Search_Lucene_Exception
     */
    private static function _startReadLockProcessing(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @param Zend_Search_Lucene_Storage_Directory $lockDirectory
     */
    private static function _stopReadLockProcessing(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @throws Zend_Search_Lucene_Exception
     */
    public static function obtainReadLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @param Zend_Search_Lucene_Storage_Directory $lockDirectory
     */
    public static function releaseReadLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @return boolean
     */
    public static function escalateReadLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @param Zend_Search_Lucene_Storage_Directory $lockDirectory
     */
    public static function deEscalateReadLock(Storage\Directory\Directory $lockDirectory)
    {
        $lock = $lockDirectory->getFileObject(self::READ_LOCK_FILE);
        $lock->lock(LOCK_SH);
    }
     ...
     * @return mixed
     */
    public static function obtainOptimizationLock(Storage\Directory\Directory $lockDirectory)
    {
     ...
     * @param Zend_Search_Lucene_Storage_Directory $lockDirectory
     */
    public static function releaseOptimizationLock(Storage\Directory\Directory $lockDirectory)
    {
