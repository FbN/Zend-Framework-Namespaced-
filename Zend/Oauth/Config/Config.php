...
class Config implements ConfigInterface
{
     ...
     * @return Zend_Oauth_Config
     */
    public function setRsaPublicKey(\Zend\Crypt\Rsa\Key\Public $key)
    {
     ...
     * @return Zend_Oauth_Config
     */
    public function setRsaPrivateKey(\Zend\Crypt\Rsa\Key\Private $key)
    {
     ...
     * @return Zend_Oauth_Config
     */
    public function setToken(Oauth\Token\Token $token)
    {
        $this->_token = $token;
        return $this;
    }
