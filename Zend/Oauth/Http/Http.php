...
class Http
{
     ...
     * @var string
     */
    protected $_preferredRequestMethod = Oauth\Oauth::POST;
    ...
    {
        if (!in_array($method, array(Oauth\Oauth::POST, Oauth\Oauth::GET))) {
            require_once 'Zend/Oauth/Exception.php';
            throw new Oauth\Exception('invalid HTTP method: ' . $method);
        }
    ...
    public function startRequestCycle(array $params)
    {
        ...
        try {
            ...
            require_once 'Zend/Oauth/Exception.php';
            throw new Oauth\Exception('Error in HTTP request', null, $e);
        }
        if ($response !== null) {
