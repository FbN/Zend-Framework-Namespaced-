...
class AutoDiscover implements \Zend\Server\ServerInterface
{
    ...
    public function setUri($uri)
    {
        if (!is_string($uri) && !($uri instanceof Uri\Uri)) {
            ...
            throw new Exception("No uri given to Zend_Soap_AutoDiscover::setUri as string or Zend_Uri instance.");
        }
        $this->_uri = $uri;
    ...
    public function getUri()
    {
        if($this->_uri !== null) {
            ...
            $uri = Uri\Uri::factory($schema . '://' . $host . $scriptName);
            $this->setUri($uri);
        }
        return $uri;
    }
    ...
    public function setWsdlClass($wsdlClass)
    {
        if (!is_string($wsdlClass) && !is_subclass_of($wsdlClass, 'Zend_Soap_Wsdl')) {
            require_once "Zend/Soap/AutoDiscover/Exception.php";
            throw new Exception("No Zend_Soap_Wsdl subclass given to Zend_Soap_AutoDiscover::setWsdlClass as string.");
        }
    ...
    public function setClass($class, $namespace = '', $argv = null)
    {
        ...
        $wsdl = new $this->\\wsdlClass($class, $uri, $this->_strategy);
