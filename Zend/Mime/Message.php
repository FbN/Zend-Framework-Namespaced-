...
class Message
{
     ...
     * @return string
     */
    public function generateMessage($EOL = MimeMime::LINEEND)
    {
        if (! $this->isMultiPart()) {
     ...
     * @return string
     */
    public function getPartHeaders($partnum, $EOL = MimeMime::LINEEND)
    {
     ...
     * @return string
     */
    public function getPartContent($partnum, $EOL = MimeMime::LINEEND)
    {
    ...
    protected static function _disassembleMime($body, $boundary)
    {
        ...
        if ($p===false) {
            throw new end\Exception('Not a valid Mime Message: End Missing');
        }
     ...
     */
    public static function createFromMessage($message, $boundary, $EOL = MimeMime::LINEEND)
    {
            ...
            foreach ($part['header'] as $key => $value) {
                ...
                switch(strtolower($key)) {
                    ...
                    case 'content-language':
                        ...
                        break;
                    default:
                        throw new end\Exception('Unknown header ignored for MimePart:' . $key);
                }
            }
            $res->addPart($newPart);
        }
