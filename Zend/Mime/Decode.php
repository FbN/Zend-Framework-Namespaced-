...
class Decode
{
     ...
     * @throws Zend_Exception
     */
    public static function splitMessageStruct($message, $boundary, $EOL = MimeMime::LINEEND)
    {
     ...
     * @return null
     */
    public static function splitMessage($message, &$headers, &$body, $EOL = MimeMime::LINEEND)
    {
    ...
    public static function splitHeaderField($field, $wantedPart = null, $firstName = 0)
    {
        ...
        if (!preg_match_all('%([^=\s]+)\s*=\s*("[^"]+"|[^;]+)(;\s*|$)%', $field, $matches)) {
            throw new end\Exception('not a valid header field');
        }
