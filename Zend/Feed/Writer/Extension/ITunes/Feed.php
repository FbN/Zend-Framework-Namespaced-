...
class Feed
{
    ...
    public function setItunesBlock($value)
    {
        if (!ctype_alpha($value) && strlen($value) > 0) {
            ...
            throw new Feed\Exception('invalid parameter: "block" may only'
    ...
    public function addItunesAuthor($value)
    {
        if (iconv_strlen($value, $this->getEncoding()) > 255) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: any "author" may only'
    ...
    public function setItunesCategories(array $values)
    {
        ...
        foreach ($values as $key=>$value) {
            if (!is_array($value)) {
                if (iconv_strlen($value, $this->getEncoding()) > 255) {
                    require_once 'Zend/Feed/Exception.php';
                    throw new Feed\Exception('invalid parameter: any "category" may only'
                    . ' contain a maximum of 255 characters each');
                }
    ...
    {
        if (!Uri\Uri::check($value)) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "image" may only'
            . ' be a valid URI/IRI');
        }
    ...
    public function setItunesDuration($value)
    {
        ...
        if (!ctype_digit($value)
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "duration" may only'
    ...
    public function setItunesExplicit($value)
    {
        if (!in_array($value, array('yes','no','clean'))) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "explicit" may only'
    ...
    public function setItunesKeywords(array $value)
    {
        if (count($value) > 12) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "keywords" may only'
    ...
    public function setItunesNewFeedUrl($value)
    {
        if (!Uri\Uri::check($value)) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "newFeedUrl" may only'
            . ' be a valid URI/IRI');
        }
    ...
    public function addItunesOwner(array $value)
    {
        if (!isset($value['name']) || !isset($value['email'])) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: any "owner" must'
        ...
        if (iconv_strlen($value['name'], $this->getEncoding()) > 255
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: any "owner" may only'
    ...
    public function setItunesSubtitle($value)
    {
        if (iconv_strlen($value, $this->getEncoding()) > 255) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "subtitle" may only'
            . ' contain a maximum of 255 characters');
        }
    ...
    public function setItunesSummary($value)
    {
        if (iconv_strlen($value, $this->getEncoding()) > 4000) {
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('invalid parameter: "summary" may only'
    ...
    {
        $point = Feed\Writer\Writer::lcfirst(substr($method, 9));
        if (!method_exists($this, 'setItunes' . ucfirst($point))
            && !method_exists($this, 'addItunes' . ucfirst($point))
        ) {
            require_once 'Zend/Feed/Writer/Exception/InvalidMethodException.php';
            throw new Feed\Writer\Exception\InvalidMethodException(
