...
class Reader
{
     ...
     * @return void
     */
    public static function setHttpClient(Client\Client $httpClient)
    {
    ...
    {
        if (!self::$_httpClient instanceof Client\Client) {
            /**
             * @see Zend_Http_Client
             */
            require_once 'Zend/Http/Client.php';
            self::$_httpClient = new Client\Client();
        }
    ...
    public static function import($uri, $etag = null, $lastModified = null)
    {
        ...
        if (self::$_httpConditionalGet && $cache) {
            ...
            if ($response->getStatus() !== 200 && $response->getStatus() !== 304) {
                ...
                throw new Feed\Exception('Feed failed to load, got response code ' . $response->getStatus());
            }
    ...
    public static function importString($string)
    {
        ...
        if (!$status) {
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception($errormsg);
        }
        ...
        if (substr($type, 0, 3) == 'rss') {
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('The URI used does not point to a '
    ...
    public static function importFile($filename)
    {
        ...
        if ($feed === false) {
             ...
             */
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception("File could not be loaded: $php_errormsg");
        }
    ...
    public static function findFeedLinks($uri)
    {
        ...
        if ($response->getStatus() !== 200) {
             ...
             */
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception("Failed to access $uri, got response code " . $response->getStatus());
        }
    ...
    public static function detectType($feed, $specOnly = false)
    {
        if ($feed instanceof FeedInterface) {
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('Invalid object/scalar provided: must'
    ...
    public static function registerExtension($name)
    {
        ...
        if (!self::getPluginLoader()->isLoaded($feedName)
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Feed\Exception('Could not load extension: ' . $name
