 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Atom extends bstract implements nterface
{
    /**
     * XPath query
     *
    ...
    public function __construct(\DOMElement $entry, $entryKey, $type = null)
    {
        ...
        $atomClass = Reader\Reader::getPluginLoader()->getClassName('Atom_Entry');
        $this->_extensions['Atom_Entry'] = new $atomClass($entry, $entryKey, $type);

        $threadClass = Reader\ReaderReader\Reader::getPluginLoader()->getClassName('Thread_Entry');
        $this->_extensions['Thread_Entry'] = new $threadClass($entry, $entryKey, $type);
        
        $threadClass = Reader\ReaderReader\Reader::getPluginLoader()->getClassName('DublinCore_Entry');
