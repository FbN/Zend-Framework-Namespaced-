...
class Source extends Atom
{
     ...
     */
    public function __construct(\DOMElement $source, $xpathPrefix, $type = Reader\ReaderReader\Reader::TYPE_ATOM_10)
    {
        ...
        $this->_extensions['Atom_Feed'] = new $atomClass($this->\\domDocument, $this->_data['type'], $this->_xpath);
        $atomClass = Reader\Reader::getPluginLoader()->getClassName('DublinCore_Feed');
        $this->_extensions['DublinCore_Feed'] = new $atomClass($this->\\domDocument, $this->_data['type'], $this->_xpath);
