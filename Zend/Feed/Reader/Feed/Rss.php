...
class Rss extends bstract
{
    ...
    public function __construct(\DomDocument $dom, $type = null)
    {
        ...
        $dublinCoreClass = Reader\Reader::getPluginLoader()->getClassName('DublinCore_Feed');
        $this->_extensions['DublinCore_Feed'] = new $dublinCoreClass($dom, $this->\\data['type'], $this->_xpath);
        $atomClass = Reader\Reader::getPluginLoader()->getClassName('Atom_Feed');
        $this->_extensions['Atom_Feed'] = new $atomClass($dom, $this->\\data['type'], $this->_xpath);
    ...
    public function getAuthors()
    {
        ...
        if (count($authors) == 0) {
            ...
            $authors = new Feed\Reader\Collection\Author(
    ...
    public function getCategories()
    {
        ...
        if ($list->length) {
            $categoryCollection = new Feed\Reader\Collection\Category;
