...
class Introspector
{
    ...
    public function introspect($serviceClass, $options = array())
    {
        ...
        if (!class_exists($serviceClass)) {
            ...
            \Zend\Loader\Loader::loadClass($serviceClass, $this->_getServicePath());
        }
    ...
    protected function _addClassAttributes($typename, \DOMElement $typexml)
    {
        ...
        $rc = new \Zend\Reflection\Class($typename);
     ...
     * @return void
     */
    protected function _addService(\Zend\Server\Reflection\Class $refclass, \DOMElement $target)
    {
     ...
     */
    protected function _getPropertyType(\Zend\Reflection\Property $prop)
    {
    ...
    protected function _phpTypeToAS($typename)
    {
        ...
        if (false !== ($asname = \Zend\Amf\Parse\TypeLoader::getMappedClassName($typename))) {
            return $asname;
        }
