 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Serializer extends Parse\Serializer
{
    /**
    ...
    public function writeTypeMarker(&$data, $markerType = null, $dataByVal = false)
    {
        ...
        if (null !== $markerType) {
            ...
            if (is_resource($data)) {
                $data = Parse\TypeLoader::handleResource($data);
            }
            switch (true) {
    ...
    public function writeAmf3TypeMarker(&$data)
    {
        ...
        $serializer = new Parse\Amf3\Serializer($this->_stream);
    ...
    protected function getClassName($object)
    {
        ...
        switch (true) {
            ...
            case Parse\TypeLoader::getMappedClassName(get_class($object)):
                $className = Parse\TypeLoader::getMappedClassName(get_class($object));
                break;
