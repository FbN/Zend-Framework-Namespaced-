 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Deserializer extends Amf\Parse\Deserializer
{
    /**
    ...
    public function readTypedObject()
    {
        ...
        $loader = Amf\Parse\TypeLoader::loadType($className);
        $returnObject = new $loader();
        $properties = \get\object\vars($this->readObject());
    ...
    public function readAmf3TypeMarker()
    {
        ...
        $deserializer = new Amf\Parse\Amf3\Deserializer($this->_stream);
