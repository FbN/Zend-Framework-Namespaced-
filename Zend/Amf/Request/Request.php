...
class Request
{
    ...
    {
        $this->_inputStream  = new Parse\InputStream($request);
        $this->_deserializer = new Amf\Parse\Amf0\Deserializer($this->_inputStream);
     ...
     * @return Zend_Amf_Request
     */
    public function readMessage(Parse\InputStream $stream)
    {
