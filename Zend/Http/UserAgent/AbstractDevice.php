    ...
    implements Device
{
    ...
    protected function _loadFeaturesAdapter()
    {
        ...
        if (empty($config['classname'])) {
            ...
            throw new Exception('The ' . $this->getType() . ' features adapter must have a "classname" config parameter defined');
        }
        ...
        if (!class_exists($className)) {
            if (isset($config['path'])) {
                ...
                require_once 'Zend/Http/UserAgent/Exception.php';
                throw new Exception('The ' . $this->getType() . ' features adapter must have a "path" config parameter defined');
            }
            
            if (false === include_once ($path)) {
                require_once 'Zend/Http/UserAgent/Exception.php';
                throw new Exception('The ' . $this->getType() . ' features adapter path that does not exist');
            }
        }
