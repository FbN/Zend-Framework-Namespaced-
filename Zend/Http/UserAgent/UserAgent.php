...
class UserAgent implements \Serializable
{
    ...
    public function setPluginLoader($type, $loader)
    {
        ...
        if (is_string($loader)) {
            if (!class_exists($loader)) {
                ...
                \Zend\Loader\Loader::loadClass($loader);
            }
            $loader = new $loader();
        } elseif (!\is\object($loader)) {
            require_once 'Zend/Http/UserAgent/Exception.php';
            throw new Exception(sprintf(
        ...
        if (!$loader instanceof PluginLoader\PluginLoader) {
            require_once 'Zend/Http/UserAgent/Exception.php';
            throw new Exception(sprintf(
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            ...
            $this->setPluginLoader($type, new PluginLoader\PluginLoader());
        }
