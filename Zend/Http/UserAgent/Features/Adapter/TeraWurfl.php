 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class TeraWurfl implements Adapter
{
    /**
    ...
    public static function getFromRequest($request, array $config)
    {
        if (!class_exists('TeraWurfl')) {
            ...
            if (!isset($config['terawurfl'])) {
                ...
                throw new Features\Exception('"TeraWurfl" configuration is not defined');
            }
            ...
            $config = $config['terawurfl'];
             ...
             if (empty($config['terawurfl_lib_dir'])) {
                // No lib_dir given
                require_once 'Zend/Http/UserAgent/Features/Exception.php';
                throw new Features\Exception('The "terawurfl_lib_dir" parameter is not defined');
            }
