...
class Client
{
    ...
    {
        if ($as_string && $this->uri instanceof Uri\Http) {
    ...
    {
        Loader\Loader::loadClass('Zend_Http_CookieJar');
    ...
    {
        Loader\Loader::loadClass('Zend_Http_Cookie');
    ...
    protected function _openTempStream()
    {
        ...
        if (false === ($fp = @fopen($this->_stream_name, "w+b"))) {
                ...
                require_once 'Zend/Http/Client/Exception.php';
                throw new Exception("Could not open temp file {$this->_stream_name}");
        }
